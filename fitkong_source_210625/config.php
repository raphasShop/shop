...
$seo_domain = ask_get_hostname(); 
define('G5_DOMAIN', $seo_domain);
...
define('G5_IMG_URL',        'https://fitkong2020.s3.ap-northeast-2.amazonaws.com/img');
