...
<div id="sit_ov_wrap" >
    ...
    <div id="sit_pvi">
        ...
        for($i=1; $i<=10; $i++) {
            ...
            $img = get_it_thumbnail($it['it_img'.$i], 600, 600);
        ...
        if($total_count > 0) {
            ...
            foreach($thumbnails as $val) {
                ...
                if ($thumb_count % 5 == 0) $sit_pvi_last = 'class="li_last"';
                    ...
                    echo '<a href="#" class="img_thumb">'.$val.'<span class="sound_only"> '.$thumb_count.'번째 이미지 새창</span></a>';
                    echo '</li>';
            }
            echo '</ul>';
        }
    ...
    <section id="sit_ov" class="2017_renewal_itemform">
        ...
        <?php if($it['it_10']) { ?>
        <h3 id="sit_evt_msg"><?php echo stripslashes($it['it_10']); ?></h3>
        <?php } ?>
        ...
        <div id="sit_ov_btn">
            ...
            <div class="kakao-friend_coupon"><img src="<?php echo G5_IMG_URL; ?>/kakao/kakao_friend_coupon3.png" style="width:280px;"></div>
            </a>
        </div>
        <?php if($member['mb_id'] == 'acropass') { 
            $pa_id = $row['pa_id'];
            $get_pa_code = get_cookie('ck_pa_code');
            $get_before_pa_code = get_cookie('ck_before_pa_code');
