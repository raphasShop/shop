...
<script>
    ...
    function kakao_hub() {
        var check = checkMobileDevice();
        if( check == false){
            location.replace('https://pf.kakao.com/_CrTxgu');
        } else {
            addPlusFriend();
        }
    }
...
<div class="customer_title_wrap">
    ...
    <div class="customer_sub_title">진행중인이벤트</div>
</div>
...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_info">
        <h2>페이지 정보</h2>
        <span class="sound_only">이벤트날짜</span> <strong><?php echo $view['wr_1']; ?></strong>
