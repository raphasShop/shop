...
<div id="customer_top_menu">
    <a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=notice"><div class="top_menu_pc_button menu_select">Notice</div></a><a href="<?php echo G5_BBS_URL ?>/faq.php"><div class="top_menu_pc_button">FAQ</div></a><a href="<?php echo G5_SHOP_URL ?>/membership.php"><div class="top_menu_pc_button">Membership</div></a><a href="<?php echo G5_SHOP_URL ?>/store.php"><div class="top_menu_pc_button">Store</div></a>
</div>
<!-- 게시판 목록 시작 { -->
