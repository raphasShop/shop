     ...
     <div class="swiper-wrapper">
                ...
                <div class="swiper-container banner-container">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide banner-slide">
                            <img src="https://d1wwy9ao3iinzu.cloudfront.net/img/banner/PC/acpc_video_banner.png" style="width:100%;height: 100%;object-fit: cover;position: absolute;">
                            <iframe width="1120" height="630" src="https://www.youtube.com/embed/D26pNy6qIIU" frameborder="0" allow="accelerometer; autoplay; loop; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="z-index: 100;outline:10px solid #fff"></iframe>
                        </div>
        ...
        <div class="swiper-slide main-vslide">
            <section class="bestProduct5">
                ...
                <?php
                    ...
                    $sql = " select * from {$g5['g5_shop_item_table']} where it_type4 = '1' AND it_use = '1' order by it_1,  it_id asc ";
                    $list = new item_list();
        ...
        <div class="swiper-slide main-vslide">
           <section class="bestProduct5">
                ...
                <?php
                    $skin = G5_SHOP_SKIN_PATH.'/main.10.skin.php'; // 스킨
                    $sql = " select * from {$g5['g5_shop_item_table']} where it_type1 = '1' AND it_use = '1' order by it_2, it_id desc ";
                    $list = new item_list();
                    $list->set_list_skin($skin);
                    $list->set_list_mod(5);
                    $list->set_query($sql);
