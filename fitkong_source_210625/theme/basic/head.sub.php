...
<meta property="og:title" content="<?php echo $it_id ? $its['it_name'] : $config['cf_title']; ?>">
<meta property="og:image" content="<?php echo $it_id ? $og_image : '/images/common/kakao.png'; ?>">
<meta property="og:description" content="아크로패스">
...
<script src="<?php echo G5_JS_URL ?>/icecream.js?ver=<?php echo G5_JS_VER;//@아이스크림플레이 ?>"></script>
...
<script src="<?php echo G5_THEME_JS_URL ?>/jquery.beforeafter-1.3.min.js?ver=11<?php echo G5_CSS_VER; ?>2"></script>
<script src="<?php echo G5_THEME_JS_URL ?>/jquery-ui-1.8.13.custom.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/countup@1.8.2/dist/countUp.min.js"></script>
<link rel="stylesheet" href="<?php echo G5_JS_URL ?>/font-awesome/css/font-awesome.min.css">
<link rel="stylesheet" href="<?php echo G5_CSS_URL ?>/swiper_pc.css">
<script>
new WOW().init();
</script>
