...
<div id="bo_list">
    ...
    <div class="list_01">
        ...
        <div scope="col">
            ...
            <label for="chkall"><span></span><span class="sound_only">현재 페이지 게시물 </span>전체선택</label>
        </div>
        <?php } ?>
        <ul>
            <?php
            ...
            <li class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
                ...
                <div class="bo_info">
                    <span class="write_name"><?php echo $list[$i]['name'] ?></span>
                    <span class="info_sep">|</span>
                    <span class="write_date"><?php echo $list[$i]['datetime2'] ?></span>
