...
add_stylesheet('<link rel="stylesheet" href="'.G5_MSHOP_SKIN_URL.'/style.css?ver='.G5_CSS_VER.''.date("H:i:s").'">', 3);
?>
...
<div id="review_popup" style="display:none;" class="wow slideInUp" data-wow-duration="1s" data-wow-delay=".3s" data-wow-offset="10">
    <div class="review_popup_top_wrap">
        ...
        <a href="javascript:doReviewPopup();" style="display: none;">    
...
<div id="sit_ov_wrap">
    ...
    for ($i=1; $i<=10; $i++)
    {
        ...
        $thumb = get_it_thumbnail($it['it_img'.$i], 560,560,$thumb_img_w, $thumb_img_h);
    ...
    <section id="sit_ov" class="2017_renewal_itemform">
        ...
        <div class="sit_ov_wr">
            <div id="sit_title_wrap">
                ...
                <?php if($it['it_10']) { ?>
                <div class="sit_evt_msg"><?php echo $it['it_10']; ?></div>
                <?php } ?>
                <?php if($it['it_cust_price'] != get_price($it) ) { ?>
                <div class="sit_cust_price"><?php echo display_price($it['it_cust_price']); ?></div>
                <? } ?>
                <div class="sit_price">
            ...
            <div class="sit_ov_tbl">
                <div class="sit_title">제품구성 및 기타안내 </div>
                <table >
                <colgroup>
                    <col class="grid_2">
                    <col>
                ...
                if($it['it_sc_type'] == 1)
                    ...
                    if($it['it_sc_method'] == 1)
                        ...
                        if($it['it_sc_minimum'] != 0) {
                            $sc_method = '주문시 결제('.$it['it_sc_minimum'].'원 이상 무료)';
                        } else {
                            $sc_method = '무료배송';
                        }
                    }
        ...
        <div id="sit_ov_btn">
            ...
            <div class="kakao-friend_coupon"><img src="<?php echo G5_IMG_URL; ?>/kakao/kakao_friend_coupon3.png" style="width:80%; margin-top:20px;"></div></a>
        </div>

        <?php
            if(!$option_item & !$is_soldout ) {
        ?>
        <div id="floating_purchase" class="floating_purchase floating_remove">
            <?php if ($is_orderable) { ?>
            <input type="submit" onclick="document.pressed=this.value;" value="장바구니" id="sit_btn_cart">
            <input type="submit" onclick="document.pressed=this.value;" value="바로구매" id="sit_btn_buy">
            <?php } ?>
...
<div id="item_info">
    <section id="item_info_loc"></section>
...
<!-- 관련상품 시작 { -->
<section id="sit_rel">
    <h2>이 제품을 구매한 다른 고객의 상품</h2>
    <div class="sct_wrap">
        <?php
        $rel_skin_file = G5_MSHOP_SKIN_PATH.'/main.10.skin.php'; // 스킨
...
$(window).scroll(  
    function(){  
        ...
        /* if(window.pageYOffset >= $('원하는위치의엘리먼트').offset().top){ */  
            $('#floating_purchase').addClass("floating_remove");  
        }else{  
            $('#floating_purchase').removeClass("floating_remove");  
        }  
    }  
);  
