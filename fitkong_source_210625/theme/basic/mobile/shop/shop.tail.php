...
<?php }  //인덱스에서 사용하지 않음?>
    ...
    <aside id="sideBar">
        ...
        <ul id="snb">
            <li class="snb">
                <h2>
                    <a href="<?php echo G5_SHOP_URL ?>"><b>Shop</b></a>
                </h2>
            </li>
            <li class="snb">
                <h2>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-search">
    ...
    <input class="search-input" id="searchText" name="q" placeholder="어떤 상품을 찾으세요?"><div class="search-submit"><i class="xi-search" onclick="shopSearch()"></i></div>
    </form>
  </div>
