...
$sql_lc = " select count(*) as cnt from {$g5['g5_shop_coupon_table']} where cp_subject = '다이어트 성공하소!' and mb_id = '$mb_id' ";
...
$startdate_str = "2021-01-08 00:00:00";
$enddate_str = "2021-01-22 00:00:00";
