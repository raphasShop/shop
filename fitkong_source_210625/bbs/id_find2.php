...
$msg = "[핏콩]\r\n".$mb['mb_name']."님의 아이디는 ".$mb['mb_id']."입니다.";
$rst = kakaomsg('http://api.apistore.co.kr/kko/1/msg/fitkong', array('PHONE'=>$kakao_rcv_number, 'CALLBACK'=>'01085808413', 'MSG'=>$msg, 'TEMPLATE_CODE'=>'FK0008', 'BTN_TYPES'=>'', 'BTN_TXTS'=>''));
