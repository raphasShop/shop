...
<div id="shop_cart_wrap">
    <div class="shop_main_title">주문하기</div>
    <div class="shop_con_wrap">
        <form name="forderform" id="forderform" method="post" action="<?php echo $order_action_url; ?>" autocomplete="off">
        <div id="sod_frm">
            <!-- 주문상품 확인 시작 { -->
            <div class="tbl_head04 tbl_wrap od_prd_list">
                <table id="sod_list">
                <thead>
                <tr>
                ...
                for ($i=0; $row=sql_fetch_array($result); $i++)
                {
                    ...
                    $it_name = '<span class="od_prd_title">' . stripslashes($row['it_name']) . '</span>';
                ...
                <tr>
                    ...
                    <td class="td_prd">
                        ...
                        <div class="sod_name">
                            ...
                            <div class="sod_ct_price"><span class="total_price"><?php echo number_format($row['ct_price']); ?></span>원</div>
            ...
            <div>
                ...
                <section id="sod_frm_orderer">
                    ...
                    <div class="tbl_frm01 tbl_wrap">
                        ...
                        <tr>
                            <th scope="row"><label for="od_pwd">주문비밀번호</label></th>
                            <td>
                    ...
                    <div class="tbl_frm01 tbl_wrap">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <label for="ad_default"> <span></span>기본배송지로 설정</label>
                            </td>
                        </tr>
                        <?php } ?>
                        <tr>
            ...
            <section id="sod_frm_payorder">
                ...
                <div id="sod_bsk_tot">
                    <ul>
                        ...
                        <!-- 임직원 할인 --
                        <?php if($member['mb_level'] == 5) { $member_discount = round($tot_sell_price * 0.5); ?>
                        <li class="sod_bsk_point">
                            <span>임직원할인</span>
                            <strong>-<?php echo number_format($member_discount); ?></strong>원
                        </li>
                        <?php } ?>
                        -->
                ...
                <section id="sod_frm_pay">
                    ...
                    <div class="pay_tbl">
                        ...
                        <tr>
                            ...
                            <td colspan="1"><input type="text" name="coupon_code" class="coupon_board_input" id="coupon_code" value="" placeholder="쿠폰코드입력"><button type="button" id="code_coupon_btn" class="btn_frmline">쿠폰등록</button></td>
                    ...
                    <div class="sod_frm_point">
                        <div>
                            <label for="od_temp_point">사용 적립금(원)</label>
                            <input type="hidden" name="max_temp_point" value="<?php echo $temp_point; ?>">
                            <input type="text" name="od_temp_point" value="0" id="od_temp_point" class="frm_input" size="10" onKeyup="point_change(this.value);"><button type="button" id="point_all_use" class="btn_frmline">전액사용</button>
                        </div>
                        <div id="sod_frm_pt">
                            <span><strong>보유적립금</strong><?php echo display_point($member['mb_point']); ?></span>
                            <span class="max_point_box"><strong>최대 사용 가능 적립금</strong><em id="use_max_point"><?php echo display_point($temp_point); ?></em></span>
                        </div>
                    </div>
                    <?php } else { ?>
                    <input type="hidden" name="od_temp_point" value="0" id="od_temp_point" class="frm_input" size="10">
                    <div style="margin: 10px 0; background: #fff; line-height: 20px;text-align: center;padding: 10px 10px;font-size:12px;">
                        특별 이벤트 행사기간에는 쿠폰 및 적립금을<br>중복 사용하실 수 없습니다
                    </div>
                    ...
                    <div id="od_pay_sl">
                        ...
                        if ($default['de_iche_use']) {
                            $multi_settle++;
                            echo '<input type="radio" id="od_settle_iche" name="od_settle_case" value="계좌이체" '.$checked.'> <label for="od_settle_iche" class="lb_icon iche_icon">'.$escrow_title.'실시간계좌이체</label>'.PHP_EOL;
                            $checked = '';
                        }
...
$(function() {
    ...
    */
    ...
    $("#point_all_use").click(function() {
        var $this = $(this);
        var tmp_point = parseInt($("input[name=max_temp_point]").val());
        $("input[name=od_temp_point]").val(tmp_point);
...
function calculate_order_price()
{
    ...
    $("#od_tot_price .print_price").text(number_format(String(tot_price-send_point)));
    <?php if($temp_point > 0 && $is_member) { ?>
    calculate_temp_point();
    <?php } ?>
}
...
function forderform_check(f)
{
    ...
    check_field(f.od_hp, "주문하시는 분의 핸드폰 번호를 입력하십시오.");
