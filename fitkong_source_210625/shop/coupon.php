...
<div id="mypage_wrap">
    <div class="mypage_con_wrap">
        ...
        <div class="coupon_board_wrap">
            ...
            <div class="coupon_board_title">쿠폰등록</div>
        ...
        <div class="coupon_list">
            ...
            ?>
            <li class="<?php if($cp_count%2 == 0) { echo 'left_coupon'; } else { echo 'right_coupon'; } ?>">
                <div class="li_pd">
            ...
            if(!$cp_count) { ?>
                <div class="coupon_list_none">
                    ...
                    <div class="coupon_list_none_msg">쿠폰 내역이 없습니다.</div>
                </div>
            <?php } ?>
            </ul>
        </div>
