...
if(!$row['cz_id']) 
	alert("입력하신 쿠폰코드가 올바르지 않습니다");

$alert_msg = "입력하신 쿠폰코드의 사용기간이 아닙니다\n쿠폰사용기간 : ".$row['cz_code_start']." ~ ".$row['cz_code_end'];

if($row['cz_code_start'] > G5_TIME_YMD)
	alert("입력하신 쿠폰코드의 사용기간이 아닙니다. 쿠폰사용기간 : ".$row['cz_code_start']." ~ ".$row['cz_code_end']);

if($row['cz_code_end'] < G5_TIME_YMD)
	alert("입력하신 쿠폰코드의 사용기간이 만료되었습니다");
