...
<div id="shop_cart_wrap">
    <div class="shop_main_title">주문완료</div>
        ...
        <div class="shop_con_msg_wrap">        
            <div id="sod_fin_no"><div class="sod_fin_msg">주문이 정상적으로 완료되었습니다. 아래 가상계좌로 입금을 요청드립니다.</div><div class="sod_fin_bank_account"><?php echo $od['od_bank_account']; ?></div>
            ...
            <?php if($cp_offer == 1 && $order_price_coupon_use) { ?>
                <div id="sod_fin_no">주문해주셔서 감사드립니다!<br>입금을 완료하시면, <?php echo number_format($od_value); ?>원 이상 구매고객에게 <strong><?php echo $cp_value; ?>% 할인쿠폰</strong> 을 제공해드립니다.</div>
            <?php } ?>
        </div>
        <?
            } else {
        ?>
        <div class="shop_con_msg_wrap">
            <div id="sod_fin_no"><div class="sod_fin_msg">결제가 정상적으로 완료되었습니다.</div><div class="sod_fin_bank_account">상품이 준비중입니다. 발송 후 알림톡으로 안내드리겠습니다.</div></div>
            <?php if($cp_offer == 1) { ?>
                <div id="sod_fin_no">주문해주셔서 감사드립니다!<br><?php echo number_format($od_value); ?>원 이상 구매고객에게 <strong> <?php echo $cp_value; ?>% 할인쿠폰 </strong> 을 제공해드립니다.</div>
            <?php } ?>
        </div>
        <?        
            }
                        ...
                        for($k=0; $opt=sql_fetch_array($res); $k++) {
                            ...
                            <tr>
                                ...
                                <td headers="th_itname" class="td_bdno">
                                    ...
                                    <div class="td_itopt"><?php echo get_text($opt['ct_option']); ?> <?php echo number_format($opt['ct_qty']); ?>개</div>
                                    <div class="td_itprice"><?php echo number_format($sell_price); ?>원</div>
                                </td>
                            </tr>
                            <?php } ?>
