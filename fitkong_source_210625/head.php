...
<div id="pchd">
    ...
    <div id="hd_wrapper">
        ...
        <div class="logo">
            <a href="<?php echo G5_URL ?>"><img src="<?php echo G5_IMG_URL ?>/logo.png?210610" alt="<?php echo $config['cf_title']; ?>"></a>
        </div>
        ...
        <div class="search_area">
            <div class="search_wrap">
              <form name="frmdetailsearch" action="<?php echo G5_SHOP_URL ?>/search.php" id="frmsearch" onsubmit="return searchSubmit();">
