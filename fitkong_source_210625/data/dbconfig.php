...
define('G5_MYSQL_PASSWORD', 'DB패스워드');
define('G5_MYSQL_DB', 'DB명');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'acropass_');
...
$g5['search_tag_table'] = G5_TABLE_PREFIX.'search_tag'; // 추천검색어 테이블
$g5['promotion_address_table'] = G5_TABLE_PREFIX.'promotion'; // 프로모션 단축 URL 테이블
$g5['promotion_access_table'] = G5_TABLE_PREFIX.'promotion_access'; // 프로모션 단축 URL 접속 로그 테이블
$g5['promotion_behavior_table'] = G5_TABLE_PREFIX.'promotion_behavior'; // 프로모션 단축 URL 행동 로그 테이블
$g5['promotion_member_relation_table'] = G5_TABLE_PREFIX.'member_relation'; // 회원 계정 접속자 관계 테이블
$g5['promotion_naverpay_relation_table'] = G5_TABLE_PREFIX.'naverpay_relation'; // 네이버페이 주문 상품 관계 테이블
$g5['behavior_log_table'] = G5_TABLE_PREFIX.'behavior_log'; // 행동 로그 테이블

include_once(G5_PATH.'/icecream/dbconfig/dbconfig_g5_icecream.php');

define('G5_USE_SHOP', true);

define('G5_SHOP_TABLE_PREFIX', 'acropass_shop_');
...
$g5['g5_shop_cart_naverpay_table'] = G5_SHOP_TABLE_PREFIX.'cart_naverpay'; // 장바구니 테이블
...
$g5['g5_shop_item_use_relation_table'] = G5_SHOP_TABLE_PREFIX.'item_use_relation'; // 상품 관련 사용후기 테이블
...
$g5['g5_shop_coupon_code_table'] = G5_SHOP_TABLE_PREFIX.'coupon_code'; // 쿠폰코드 테이블
$g5['g5_shop_coupon_code_log_table'] = G5_SHOP_TABLE_PREFIX.'coupon_code_log'; // 쿠폰코드 사용정보 테이블
...
$g5['g5_shop_event_apply_table'] = G5_SHOP_TABLE_PREFIX.'event_apply';  // 이벤트 응모 테이블
$g5['g5_shop_review_popup_table'] = G5_SHOP_TABLE_PREFIX.'review_popup';  // 리뷰 팝업 테이블
$g5['g5_shop_review_popup_log_table'] = G5_SHOP_TABLE_PREFIX.'review_popup_log';  // 리뷰 팝업 로그 테이블
$g5['g5_shop_review_event_table'] = G5_SHOP_TABLE_PREFIX.'review_event';  // 리뷰 이벤트 테이블
$g5['g5_shop_review_event_log_table'] = G5_SHOP_TABLE_PREFIX.'review_event_log';  // 리뷰 이벤트 로그 테이블
$g5['g5_shop_con_banner_table'] = G5_SHOP_TABLE_PREFIX.'con_banner'; // 컨텐츠배너 테이블

include_once(G5_PATH.'/icecream/dbconfig/dbconfig_yc_icecream.php');
?>