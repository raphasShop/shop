...
#######################################################################################
/* 주문목록 PC용 [아이스크림 소스] */
// 삽입함수 include_once(G5_ADMIN_PATH.'/icecream_skin/pc/orderlist.skin.php');
#######################################################################################
?>
...
<div class="tbl_head02 tbl_wrap">
    ...
    <tr>
        <th scope="col" rowspan="3">
            <label for="chkall" class="sound_only">주문서보기</label>보기
        </th>
        <th scope="col" id="th_odrnum" rowspan="3" colspan="2">
        <a href="<?php echo title_sort("od_id", 1)."&amp;$qstr1"; ?>">주문번호</a>
        </th>
        <th scope="col" id="th_odrer"><i class="far fa-user white"></i> 주문자</th>
        <th scope="col" id="th_odrertel">주문자전화</th>
        <th scope="col" rowspan="4" width="100">주문합계<br>선불배송비포함<br>배송비</th>
        <th scope="col" rowspan="4" width="100">입금합계</th>
        <th scope="col" rowspan="4" width="90">주문취소</th>
        <th scope="col" rowspan="4" width="80">쿠폰</th>
        <th scope="col" rowspan="4" width="90">미수금</th>
        <th scope="col" rowspan="4">메모</th>
    </tr>
    <tr>
    ...
    <tr>
        <th scope="col" id="th_odrid"><i class="fas fa-user-plus skyblue"></i> 받는분</th>
    ...
    <tr>
        ...
        <th scope="col" id="delino">배송회사</th>
        <th scope="col" id="delicom">운송장번호</th>
    </tr>
    </thead>
    ...
    <tr class="orderlist<?php echo ' '.$bg; ?>">
        <td rowspan="3" class="td_chk">
            <a href="<?php echo G5_ADMIN_URL; ?>/shop_admin/orderform.php?od_id=<?php echo $row['od_id']; ?>&amp;<?php echo $qstr; ?>" class="at-tip" data-original-title="<nobr>주문서보기</nobr>" data-toggle="tooltip" data-placement="top" data-html="true"><img src="<?php echo G5_ADMIN_URL;?>/img/icon/layout_add.png" border="0" /></a>
        </td>
        <td headers="th_ordnum" class="td_odrnum2" rowspan="3" colspan="2">
		    <!-- 주문번호 -->
        ...
        <td headers="th_odrer" class="td_name" title="주문자로검색"><?php echo $mb_nick; ?></td>
        <td headers="th_odrertel" class="td_tel"><?php echo get_text($row['od_tel']); ?></td>
        <td rowspan="4" class="td_numsum">
        ...
        <td rowspan="4" class="td_numincome">
        ...
        <td rowspan="4" class="td_numcancel<?php echo $td_color; ?>">
        ...
        <td rowspan="4" class="td_numcoupon"><?php echo ($row['couponprice']) ? '<b>'.number_format($row['couponprice']).'</b>' : '-'; //쿠폰금액?></td>
        <td rowspan="4" class="td_numrdy">
        ...
        <td rowspan="4" class="td_memoetc"><?php echo $row['od_shop_memo']; ?></td>
    </tr>
    ...
    <!-- 추가행 -->
    <tr class="<?php echo $bg; ?>">
        <td headers="th_odrid" title="받는분으로검색"><a href="<?php echo $_SERVER['SCRIPT_NAME']; ?>?sort1=<?php echo $sort1; ?>&amp;sort2=<?php echo $sort2; ?>&amp;sel_field=od_b_name&amp;search=<?php echo get_text($row['od_b_name']); ?>"><i class="fa fa-user-plus skyblue"></i> <?php echo get_text($row['od_b_name']); ?></a></td>
    ...
    <tfoot>
    <tr class="orderlist">
        <th scope="row" colspan="4">현재 페이지 소계</th>
