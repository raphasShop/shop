...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        ...
        <td>
            <input type="text" name="gr_subject" value="<?php echo get_text($group['gr_subject']) ?>" id="gr_subject" required class="required frm_input">
            <?php
            if ($w == 'u')
    ...
    <tr>
        ...
        <td>
            ...
            <label class="switch-check">
                <input type="checkbox" name="gr_use_access" value="1" id="gr_use_access" <?php echo $gr['gr_use_access']?'checked':''; ?>> 사용
...
<div id="bq_right1">   
    <div class="bq_basic">
    <a href="./boardgroup_list.php?<?php echo $qstr ?>"><i class="fas fa-tasks"></i> 목록</a>
    </div>
