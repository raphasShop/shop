                    ...
                    if (isset($sub_menu) && $sub_menu && (substr($sub_menu, 0, 3) == substr($menu['menu'.$key][0][0], 0, 3))) {
                        ...
                        foreach($menu['menu'.$menu_key] as $key=>$value) {
                            if($key > 0) {
                                ...
                                if($member['mb_id'] == 'administrator' && (($menu_key == '155' && ($key == 1 || $key == 2 || $key == 3 || $key == 4 || $key == 5 || $key == 6 || $key == 10 || $key == 16 || $key == 18)) || ($menu_key == '200' && ($key == 3 || $key == 5 || $key == 6 || $key == 7 || $key == 9)) || ($menu_key == '300' && ($key == 1 || $key == 2 || $key == 3 || $key == 4 || $key == 5 || $key == 9)) || ($menu_key == '400' && ($key == 8 || $key == 9 || $key == 10 || $key == 11)) || ($menu_key == '411' && ($key == 1 || $key == 3)) || ($menu_key == '422' && ($key == 4 || $key == 5 || $key == 6 || $key == 10)) || ($menu_key == '455' && $key == 3) || ($menu_key == '500' && $key == 13))) {} else {
