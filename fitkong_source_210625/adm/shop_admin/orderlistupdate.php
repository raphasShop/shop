...
for ($i=0; $i<count($_POST['chk']); $i++)
{
    ...
    switch ($current_status)
    {
        ...
        case '준비' :
            ...
            // 알림톡전송 시작
            //----------------------------------------------------------
            if($delivery_company || $invoice) {
                $od['od_invoice'] = $invoice;
                $od['od_delivery_company'] = $delivery_company;
            }
            ...
            $msg = "[핏콩]\r\n안녕하세요. ".$od['od_name']."님!\r\n주문하신 상품이 발송되었습니다.\r\n \r\n- 상품명: ".$ite['it_name']."\r\n- 택배사: ".$delivery['delivery_company']."\r\n- 운송장번호: ".$delivery['invoice']."\r\n \r\n공휴일 제외 1~2일 내 배송될 예정입니다.";
            $rst = kakaomsg('http://api.apistore.co.kr/kko/1/msg/fitkong', array('PHONE'=>$kakao_rcv_number, 'CALLBACK'=>'01085808413', 'MSG'=>$msg, 'TEMPLATE_CODE'=>'FK0004', 'BTN_TYPES'=>'배송조회', 'BTN_TXTS'=>'배송조회'));
