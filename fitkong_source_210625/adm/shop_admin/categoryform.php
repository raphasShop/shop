...
<section id="anc_scatefrm_basic">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td><input type="text" name="ca_name" value="<?php echo $ca['ca_name']; ?>" id="ca_name" required class="required frm_input w100per"></td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <input type="text" name="ca_order" value="<?php echo $ca['ca_order']; ?>" id="ca_order" class="frm_input" size="10">
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <input type="checkbox" name="ca_cert_use" value="1" id="ca_cert_use"<?php echo $ca['ca_cert_use']?' checked':''; ?>> 사용
                <div class="check-slider round"></div>
                </label>
                <label for="ca_cert_use">본인확인사용</label>
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <label class="switch-check">
                <input type="checkbox" name="ca_adult_use" value="1" id="ca_adult_use"<?php echo $ca['ca_adult_use']?' checked':''; ?>> 사용
                <div class="check-slider round"></div>
                </label>
                <label for="ca_adult_use">성인인증사용</label>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="ca_sell_email w100per" value="<?php echo $ca['ca_sell_email']; ?>" id="ca_sell_email" class="frm_input">
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <label class="switch-check">
                <input type="checkbox" name="ca_nocoupon" <?php echo ($ca['ca_nocoupon']) ? "checked" : ""; ?> value="1" id="ca_nocoupon"> 예
                <div class="check-slider round"></div>
                </label>
                <label for="ca_nocoupon"><span class="blue font-14 font-bold">on</span> 으로 설정시 쿠폰적용안함</label>
            </td>
        </tr>
        </tbody>
        </table>
...
<?php echo preg_replace('#</div>$#i', '<button type="button" class="shop_category btn btn-skyblue">테마설정 가져오기</button></div>', $frm_submit); ?>
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="ca_include_head" value="<?php echo $ca['ca_include_head']; ?>" id="ca_include_head" class="frm_input w100per">
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <input type="text" name="ca_include_tail" value="<?php echo $ca['ca_include_tail']; ?>" id="ca_include_tail" class="frm_input w100per">
            </td>
        </tr>
...
<div id="bq_right1">   
    <div class="bq_basic">
    <a href="./categorylist.php?<?php echo $qstr ?>"><i class="fas fa-tasks"></i> 목록</a>
    </div>
