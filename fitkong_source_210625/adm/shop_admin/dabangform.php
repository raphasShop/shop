<?php
$sub_menu = '155702'; /* 수정전 원본 메뉴코드 500500 */
...
{
    $html_title .= ' 수정';
    $sql = " select * from {$g5['g5_shop_dabang_table']} where co_id = '$co_id' ";
    $co = sql_fetch($sql);
}
else
{
...
<form name="fbanner" action="./dabangformupdate.php" method="post" enctype="multipart/form-data">
...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        ...
        <td>
            ...
            <?php
            $bimg_str = "";
            $bimg = G5_DATA_PATH."/dabang/{$co['co_id']}";
            if (file_exists($bimg) && $co['co_id']) {
                ...
                $bimg_str = '<img src="'.G5_DATA_URL.'/dabang/'.$co['co_id'].'" width="'.$width.'">';
            }
            if ($bimg_str) {
...
<div id="bq_right1">   
    <div class="bq_basic">
    <a href="./dabanglist.php"><i class="fas fa-tasks"></i> 목록</a>
    </div>
