...
<div class="dan-datebox_mobile" style="margin-bottom:20px;"><!-- 분류별검색창 -->
    <div class="row"><!-- row 시작 { -->
        ...
        <strong>월별매출</strong>
        <input type="text" name="fr_month" value="<?php echo $fr_month; ?>" id="fr_month" required class="required frm_input" size="7" maxlength="7" style="width:65px;">
        <label for="fr_month">월 ~</label>
        <input type="text" name="to_month" value="<?php echo $to_month; ?>" id="to_month" required class="required frm_input" size="7" maxlength="7" style="width:65px;">
