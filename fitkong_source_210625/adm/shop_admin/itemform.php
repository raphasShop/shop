...
<div class="compare_wrap_nostyle">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <?php echo ($i == 2) ? '<span class="lightpink font-normal font-11">누끼이미지</span><br>' : ''; //대표이미지?>
...
<section id="anc_sitfrm_event" class="srel" style="display: none;">
    <?php echo $pg_anchor; ?>
