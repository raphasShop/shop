<?php
$sub_menu = '155301'; /* 수정전 원본 메뉴코드 500500 */
...
<input type="hidden" name="dvc" value="<?php echo $dvc; ?>">
...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr style="display: none;">
        ...
        <td>
            ...
            <select name="bn_device" id="bn_device">
                <option value="pc"<?php echo get_selected($dvc, 'pc'); ?>>PC</option>
                <option value="mobile"<?php echo get_selected($dvc, 'mobile'); ?>>모바일</option>
        </select>
        </td>
    </tr>
    <tr style="display: none;">
    ...
    <tr style="display: none">
        ...
        <td>
            ...
            <input type="checkbox" name="bn_border" value="1" id="bn_border"<?php echo $bn['bn_border']?' checked':''; ?>> 사용
            <div class="check-slider round"></div>
            </label>
            <label for="bn_border">테두리 사용설정</label>
        </td>
    </tr>
    <tr>
...
<div id="bq_right1">   
    <div class="bq_basic">
    <a href="./bannerlist.php?&amp;dvc=<?php echo $dvc; ?>&amp;position=<?php echo $position; ?>"><i class="fas fa-tasks"></i> 목록</a>
    </div>
