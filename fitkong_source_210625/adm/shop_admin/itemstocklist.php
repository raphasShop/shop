...
<div class="local_desc03 local_desc">
    ...
    <select id="ssch_sort" onChange="window.location.href=this.value">
        ...
        <option value="<?php echo $sortlist; ?>it_stock_qty&amp;sort2=asc&amp;page=<?php echo $page;?>">재고 적은순</option>
        <option value="<?php echo $sortlist; ?>it_stock_qty&amp;sort2=desc&amp;page=<?php echo $page;?>">재고 많은순</option>
        <option value="<?php echo $sortlist; ?>it_id&amp;sort2=desc&amp;page=<?php echo $page;?>">상품코드 최근순</option>
        <option value="<?php echo $sortlist; ?>it_id&amp;sort2=asc&amp;page=<?php echo $page;?>">상품코드 과거순</option>
        <option value="<?php echo $sortlist; ?>it_name&amp;sort2=asc&amp;page=<?php echo $page;?>">상품명 순</option>
        <option value="<?php echo $sortlist; ?>it_name&amp;sort2=desc&amp;page=<?php echo $page;?>">상품명 역순</option>
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" colspan="2"><a href="<?php echo title_sort("it_name") . "&amp;$qstr1"; ?>">상품명</a></th>
    ...
    for ($i=0; $row=sql_fetch_array($result); $i++)
    {
        ...
        if(!$row2['cnt']) {
            ...
            //$wait_qty = $row1['sum_qty'] + $row2['sum_qty'];
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td class="td_num">
            ...
            <input type="text" name="it_stock_qty[<?php echo $i; ?>]" value="<?php echo $row['it_stock_qty']; ?>" id="stock_qty_<?php echo $i; ?>" class="frm_input" size="6" autocomplete="off">
        </td>
        <td class="td_num">
            <label for="noti_qty_<?php echo $i; ?>" class="sound_only">통보수량</label>
            <input type="text" name="it_noti_qty[<?php echo $i; ?>]" value="<?php echo $row['it_noti_qty']; ?>" id="noti_qty_<?php echo $i; ?>" class="frm_input" size="6" autocomplete="off">
        </td>
        <td class="td_chk">
