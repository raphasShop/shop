<?php
$sub_menu = "155102"; /* 변경전 메뉴코드 100290 */
...
// $sql = " select * from {$g5['menu_table']} order by length(me_code) = '2' asc ";
...
<div class="local_desc01 local_desc">
    <p><strong>주의!</strong> 메뉴설정 작업 후 반드시 <strong>저장</strong>을 누르셔야 저장됩니다.</p>
</div>
...
<div id="bq_right1">
    ...
    <button type="button" onclick="return add_menu();"><i class="fas fa-plus"></i> 메뉴추가<span class="sound_only"> 새창</span></button>
    </div>
    
    <div class="bq_basic_submit">
    <input type="submit" name="act_button" value="저장">
    </div>
</div>
<!--//-->
