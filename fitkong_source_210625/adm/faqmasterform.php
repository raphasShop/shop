...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        ...
        <td>
            <input type="text" value="<?php echo get_text($fm['fm_subject']); ?>" name="fm_subject" id="fm_subject" required class="frm_input required w80per">
            <?php if ($w == 'u') { ?>
...
<div id="bq_right1">   
    <div class="bq_basic">
     <a href="./faqmasterlist.php"><i class="fas fa-tasks"></i> 목록</a>
    </div>
