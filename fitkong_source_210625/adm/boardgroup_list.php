...
<select name="sfl" id="sfl">
    <option value="gr_subject"<?php echo get_selected($_GET['sfl'], "gr_subject"); ?>>그룹명</option>
    <option value="gr_id"<?php echo get_selected($_GET['sfl'], "gr_id"); ?>>그룹아이디</option>
    <option value="gr_admin"<?php echo get_selected($_GET['sfl'], "gr_admin"); ?>>그룹관리자ID</option>
</select>
<label for="stx" class="sound_only">검색어<strong class="sound_only"> 필수</strong></label>
<input type="text" name="stx" value="<?php echo $stx ?>" required class="required frm_input_big">
...
<div class="local_desc03 local_desc">
    <div class="totallist"><strong><?php echo number_format($total_count) ?></strong> 개의 게시판그룹이 검색되었습니다</div>
</div>
<!-- // -->
...
<div id="bq_right1">
    ...
    <?php if ($is_admin == 'super') { // 게시판그룹추가 ?>
    <div class="bq_basic_add">
    <a href="./boardgroup_form.php" id="bo_gr_add"><i class="fa fa-plus"></i> 그룹추가</a>
    </div>
    <?php } ?>
</div>
<!--//-->
