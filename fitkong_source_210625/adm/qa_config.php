...
<section id="anc_cf_qa_config">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                <input type="text" name="qa_title" value="<?php echo $qaconfig['qa_title'] ?>" id="qa_title" required class="required frm_input w60per">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="qa_category" value="<?php echo $qaconfig['qa_category'] ?>" id="qa_category" required class="required frm_input w100per">
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="qa_send_number" value="<?php echo $qaconfig['qa_send_number'] ?>" id="qa_send_number" class="frm_input"  size="15">
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <input type="text" name="qa_admin_hp" value="<?php echo $qaconfig['qa_admin_hp'] ?>" id="qa_admin_hp" class="frm_input"  size="15">
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <input type="text" name="qa_admin_email" value="<?php echo $qaconfig['qa_admin_email'] ?>" id="qa_admin_email" class="frm_input w100per">
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="qa_include_head" value="<?php echo $qaconfig['qa_include_head'] ?>" id="qa_include_head" class="frm_input w100per">
            </td>
        </tr>
        <tr>
            <th scope="row"><label for="qa_include_tail">하단 파일 경로</label></th>
            <td>
                <input type="text" name="qa_include_tail" value="<?php echo $qaconfig['qa_include_tail'] ?>" id="qa_include_tail" class="frm_input w100per">
            </td>
        </tr>
