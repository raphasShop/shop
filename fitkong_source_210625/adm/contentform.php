...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        ...
        <td>
            ...
            <input type="text" value="<?php echo $co['co_id']; ?>" name="co_id" id ="co_id" required <?php echo $readonly; ?> class="required <?php echo $readonly; ?> frm_input w60per" maxlength="20">
    ...
    <tr>
        ...
        <td><input type="text" name="co_subject" value="<?php echo htmlspecialchars2($co['co_subject']); ?>" id="co_subject" required class="frm_input w100per required"></td>
    </tr>
    <tr>
        <th scope="row">내용</th>
    ...
    <tr>
        ...
        <td>
            ...
            <input type="text" name="co_include_head" value="<?php echo $co['co_include_head']; ?>" id="co_include_head" class="frm_input w100per">
        </td>
    </tr>
    <tr>
        ...
        <td>
            ...
            <input type="text" name="co_include_tail" value="<?php echo $co['co_include_tail']; ?>" id="co_include_tail" class="frm_input w100per">
        </td>
    </tr>
...
<div id="bq_right1">   
    <div class="bq_basic">
    <a href="./contentlist.php"><i class="fas fa-tasks"></i> 목록</a>
    </div>
