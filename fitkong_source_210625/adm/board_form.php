...
*/
$frm_submit = '<div class="btn_confirm01 btn_confirm"><div class="h10"></div>'.PHP_EOL;
...
<section id="anc_bo_basic">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td colspan="2">
                <input type="text" name="bo_table" value="<?php echo $board['bo_table'] ?>" id="bo_table" <?php echo $required ?> <?php echo $readonly ?> class="frm_input <?php echo $reaonly ?> <?php echo $required ?> <?php echo $required_valid ?>">
                <?php if ($w == '') { ?>
        ...
        <tr>
            ...
            <td colspan="2">
                <input type="text" name="bo_subject" value="<?php echo get_text($board['bo_subject']) ?>" id="bo_subject" required class="required frm_input w100per" maxlength="120">
            </td>
        </tr>
        <tr>
            ...
            <td colspan="2">
                ...
                <input type="text" name="bo_mobile_subject" value="<?php echo get_text($board['bo_mobile_subject']) ?>" id="bo_mobile_subject" class="frm_input w100per" maxlength="120">
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="bo_category_list" value="<?php echo get_text($board['bo_category_list']) ?>" id="bo_category_list" class="frm_input w100per">
                ...
                <input type="checkbox" name="bo_use_category" value="1" id="bo_use_category"<?php echo $board['bo_use_category']?' checked':''; ?>> 분류사용
                <div class="check-slider round"></div>
                </label>
                <label for="bo_use_category">분류사용</label>
            </td>
            <td class="td_grpset">
...
<section id="anc_bo_function">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                <label class="switch-check">
                <input type="checkbox" name="bo_use_sideview" value="1" id="bo_use_sideview" <?php echo $board['bo_use_sideview']?'checked':''; ?>> 사용
                <div class="check-slider round"></div>
                </label>
                <label for="bo_use_sideview">글쓴이 클릭시 나오는 레이어 메뉴</label>
            </td>
            <td class="td_grpset">
        ...
        <tr>
            ...
            <td>
                ...
                <label class="switch-check">
                    <input type="checkbox" name="bo_use_dhtml_editor" value="1" <?php echo $board['bo_use_dhtml_editor']?'checked':''; ?> id="bo_use_dhtml_editor"> 사용
                    <div class="check-slider round"></div>
                </label>
                <label for="bo_use_dhtml_editor">에디터사용</label>
            </td>
            <td class="td_grpset">
        ...
        <tr>
            ...
            <td>
                ...
                <label class="switch-check">
                    <input type="checkbox" name="bo_use_rss_view" value="1" <?php echo $board['bo_use_rss_view']?'checked':''; ?> id="bo_use_rss_view"> 사용
                    <div class="check-slider round"></div>
                </label>
            </td>
            <td class="td_grpset">
        ...
        <tr>
            ...
            <td>
                <label class="switch-check">
                    <input type="checkbox" name="bo_use_good" value="1" <?php echo $board['bo_use_good']?'checked':''; ?> id="bo_use_good"> 사용
                    <div class="check-slider round"></div>
                </label>
            </td>
            <td class="td_grpset">
        ...
        <tr>
            ...
            <td>
                <label class="switch-check">
                    <input type="checkbox" name="bo_use_nogood" value="1" id="bo_use_nogood" <?php echo $board['bo_use_nogood']?'checked':''; ?>> 사용
                    <div class="check-slider round"></div>
                </label>
            </td>
            <td class="td_grpset">
        ...
        <tr>
            ...
            <td>
                <label class="switch-check">
                    <input type="checkbox" name="bo_use_name" value="1" id="bo_use_name" <?php echo $board['bo_use_name']?'checked':''; ?>> 사용
                    <div class="check-slider round"></div>
                </label>
            </td>
            <td class="td_grpset">
        ...
        <tr>
            ...
            <td>
                <label class="switch-check">
                    <input type="checkbox" name="bo_use_signature" value="1" id="bo_use_signature" <?php echo $board['bo_use_signature']?'checked':''; ?>> 사용
                    <div class="check-slider round"></div>
                </label>
            </td>
            <td class="td_grpset">
        ...
        <tr>
            ...
            <td>
                <label class="switch-check">
                    <input type="checkbox" name="bo_use_ip_view" value="1" id="bo_use_ip_view" <?php echo $board['bo_use_ip_view']?'checked':''; ?>> 사용
                    <div class="check-slider round"></div>
                </label>
            </td>
            <td class="td_grpset">
        ...
        <tr>
            ...
            <td>
                ...
                <label class="switch-check">
                    <input type="checkbox" name="bo_use_list_content" value="1" id="bo_use_list_content" <?php echo $board['bo_use_list_content']?'checked':''; ?>> 사용
                    <div class="check-slider round"></div>
                </label>
                <label for="bo_use_list_content">사용시 속도가 느려질 수 있습니다</label>
            </td>
            <td class="td_grpset">
        ...
        <tr>
            ...
            <td>
                ...
                <label class="switch-check">
                    <input type="checkbox" name="bo_use_list_file" value="1" id="bo_use_list_file" <?php echo $board['bo_use_list_file']?'checked':''; ?>> 사용
                    <div class="check-slider round"></div>
                </label>
                <label for="bo_use_list_file">사용시 속도가 느려질 수 있습니다</label>
            </td>
            <td class="td_grpset">
        ...
        <tr>
            ...
            <td>
                <label class="switch-check">
                    <input type="checkbox" name="bo_use_list_view" value="1" id="bo_use_list_view" <?php echo $board['bo_use_list_view']?'checked':''; ?>> 사용
                    <div class="check-slider round"></div>
                </label>
            </td>
            <td class="td_grpset">
        ...
        <tr>
            ...
            <td>
                <label class="switch-check">
                    <input type="checkbox" name="bo_use_email" value="1" id="bo_use_email" <?php echo $board['bo_use_email']?'checked':''; ?>> 사용
                    <div class="check-slider round"></div>
                </label>
            </td>
            <td class="td_grpset">
        ...
        <tr>
            ...
            <td>
                ...
                <label class="switch-check">
                    <input type="checkbox" name="bo_use_sns" value="1" id="bo_use_sns" <?php echo $board['bo_use_sns']?'checked':''; ?>> 사용
                    <div class="check-slider round"></div>
                </label>
            </td>
            <td class="td_grpset">
        ...
        <tr>
            ...
            <td>
                <label class="switch-check">
                    <input type="checkbox" name="bo_use_search" value="1" id="bo_use_search" <?php echo $board['bo_use_search']?'checked':''; ?>> 사용
                    <div class="check-slider round"></div>
                </label>
            </td>
            <td class="td_grpset">
...
<section id="anc_bo_design">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                <input type="text" name="bo_include_head" value="<?php echo $board['bo_include_head'] ?>" id="bo_include_head" class="frm_input w100per">
            </td>
            <td class="td_grpset">
        ...
        <tr>
            ...
            <td>
                <input type="text" name="bo_include_tail" value="<?php echo $board['bo_include_tail'] ?>" id="bo_include_tail" class="frm_input w100per">
            </td>
            <td class="td_grpset">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                <label for="chk_grp_point"><a href="<?php echo G5_ADMIN_URL;?>/config_board.php" class="red">게시판환경설정</a>에 입력한 포인트로 자동설정합니다</label>
            </td>
        </tr>
        <tr>
...
<div id="bq_right1">   
    <div class="bq_basic">
    <a href="./board_list.php?<?php echo $qstr ?>"><i class="fas fa-tasks"></i> 목록</a>
    </div>
