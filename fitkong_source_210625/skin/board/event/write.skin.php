...
<div class="contents_wrap">
    <div class="contents_title_wrap" >
        <div class="contents_title">핏콩이벤트</div>
    </div>
    <div class="contents_con_wrap">
        ...
        <section id="bo_w">
            ...
            if ($is_notice || $is_html || $is_secret || $is_mail) {
                $option = '';
                if ($is_notice) {
                    $option .= "\n".'<input type="checkbox" id="notice" name="notice" value="1" '.$notice_checked.'>'."\n".'<label for="notice"><span></span>이벤트 등록 &nbsp;&nbsp;</label>';
                }
            ...
            <div class="bo_w_tit write_div">
                ...
                <div id="autosave_wrapper write_div">
                    ...
                    <?php } ?>
                    <input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" required class="frm_input full_input required" size="50" maxlength="255" placeholder="이벤트 정보">
                    <input type="text" name="wr_2" value="<?php echo $wr_2 ?>" id="wr_2" class="frm_input full_input" size="50" maxlength="255" placeholder="이벤트배너 이미지주소">
