...
<section id="sit_qa_list">
    ...
    <div id="sit_qa_wbtn" style="display: none;">
    ...
    <div class="sit_qa_notice">
        <img src="<?php echo G5_IMG_URL; ?>/shop_review.png">
        <div class="sit_qa_notice_txt">핏콩제품에 관련한 궁금한 사항을 남겨주시면, 확인하는 즉시, 정확한 안내를 드리겠습니다.<br>기타 사항은 카톡 문의를 통해 남겨주시면, 친절히 안내드리겠습니다.</div>
    </div>
    <div style="display: none">
    <div class="sit_qa_title">
        <div class="sit_qa_title_state">답변상태</div><div class="sit_qa_title_txt">제목</div><div class="sit_qa_title_writer">작성자</div><div class="sit_qa_title_date">작성일</div>
    </div>
            ...
            <div id="sit_qa_con_<?php echo $i; ?>" class="sit_qa_con">
                <div class="sit_qa_p">
                    ...
                    <div class="sit_qa_qaa">
                        <img class="sit_qa_ans_img" src="<?php echo G5_IMG_URL; ?>/que_ans.png">
                        <img class="sit_qa_rep_img" src="<?php echo G5_IMG_URL; ?>/shop_review_answer.png">
...
?>
<div class="sit_qa_write_wrap"><a href="<?php echo G5_BBS_URL ?>/qawrite.php?it_id=<?php echo $it_id; ?>"><span>문의 작성 하기</span></a></div>
