...
<section id="community_recipe_wrap">
    <div id="community_recipe_top">
        <div class="community_recipe_top_icon"><img src="<?php echo G5_IMG_URL; ?>/pc_recipe_icon0.png"></div>
        <div class="community_recipe_top_title"><?php echo $co['co_title']; ?></div>
        <div class="community_recipe_top_time"><img src="<?php echo G5_IMG_URL; ?>/pc_recipe_icon2.png"> <?php echo $co['co_cook_time']; ?>&nbsp;&nbsp;&nbsp;&nbsp;<img src="<?php echo G5_IMG_URL; ?>/pc_recipe_icon3.png"> <?php echo $co['co_cook_person']; ?></div>
    </div>
    <div id="community_recipe_con">
        ...
        <div class="community_recipe_con_youtube"><a href="<?php echo $co['co_url']; ?>" target="_blank"><img src="<?php echo G5_IMG_URL; ?>/pc_recipe_youtube_btn.png"></a></div>
    </div>
...
<section id="recipe_wrap">
    <div id="recipe_top">
        <div class="recipe_top_back"><img src="<?php echo G5_IMG_URL; ?>/pc_recipe_back.png"></div>
        <div class="recipe_top_slogan"><span>핏콩레시피</span><br>핏콩 제품을 활용하여 다양한 요리를 만들어보세요!</div>
    </div>
    <div id="community_recipe">
        <div class="community_recipe_wrap">
             <?php
                ...
                ?><?php if($i%3==0) { ?><div class="community_recipe_item_line"><?php } ?><a href="<?php echo G5_SHOP_URL; ?>/recipe.php?cid=<?php echo $row['co_id']; ?>"><div class="community_recipe_item"><img src="<?php echo $row['co_img_url']; ?>" alt=""><p class="community_recipe_item_title"><?php echo $row['co_title']; ?></p><p class="community_recipe_item_time"><?php echo $row['co_cook_person']; ?> &nbsp;|&nbsp; <?php echo $row['co_cook_time']; ?></p></div></a><?php if($i%3!=2) { ?><div class="community_recipe_blank"></div><?php } ?><?php if($i%3==2) { ?></div><?php } } ?>
