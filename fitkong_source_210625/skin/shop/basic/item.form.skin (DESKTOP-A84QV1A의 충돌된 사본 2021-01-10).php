...
<div id="sit_ov_wrap">
    ...
    <section id="sit_ov" class="2017_renewal_itemform">
        <img src="<?php echo G5_IMG_URL; ?>/zzim_no_select.png" class="sit_zzim" id="sit_zzim_hide">
        ...
        <? } else { ?>
        <div id ="sit_price">
            <?php if($sale_ratio != 0) { ?><span class="sit_sale_ratio"><?php echo round($sale_ratio); ?>%</span><?php } ?>
        ...
        <div id="sit_ov_btn">
            <?php if ($is_orderable) { ?>
            <button type="submit" onclick="document.pressed=this.value;" value="장바구니" id="sit_btn_cart"><i class="xi-cart" aria-hidden="true"></i> 장바구니</button>
            <button type="submit" onclick="document.pressed=this.value;" value="바로구매" id="sit_btn_buy"><i class="xi-credit-card" aria-hidden="true"></i> 구매하기</button>
            <?php } ?>
