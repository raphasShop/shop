...
<div id="shop_orderlist_wrap">
    <div class="shop_orderlist_title">주문 내역 조회</div>
    <div class="shop_orderlist_subtitle">최근 1년 내 목록만 조회 가능합니다.</div>
    <div class="shop_orderlist_filter_wrap">
    ...
    <div class="shop_orderlist_con_wrap">
        <div id="order_list">
                ...
                <div id="sod_inquiry">
                    <ul>
                        ...
                        <li>
                            ...
                            {
                               $image = get_it_image($row2['it_id'], 100, 100);
                            ?>
