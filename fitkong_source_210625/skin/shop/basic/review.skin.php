...
<div class="review_top_banner_wrap">
	<div class="review_top_banner"><img src="<?php echo G5_IMG_URL ?>/review_top_banner.png"></div>
</div>
...
<div class="review_list_con_wrap">
	<a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=notice&wr_id=27"><div class="review_list_con_notice">[이벤트] 리뷰 작성 시 적립금 증정!</div></a>
	...
	<div class="review_list_item_wrap">
		<div class="review_list_item_image"><?php if($imgs) { ?><img src="<?php echo $imgs;?>"><? } else { ?><img src="<?php echo G5_IMG_URL ?>/review_blank_image.jpg"><?php } ?></div>
