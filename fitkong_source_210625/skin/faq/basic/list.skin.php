...
<div id="customer_wrap">
    <div class="customer_top_tab_wrap">
        <a href="<?php echo G5_BBS_URL ?>/faq.php"><div class="customer_top_tab top_tab_select eng_font">FAQ</div></a>
        <div class="customer_top_tab_space"></div>
        <a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=notice"><div class="customer_top_tab">공지사항</div></a>
        <div class="customer_top_tab_space"></div>
    ...
    <div class="customer_back_wrap">
        <div class="faq_list_cate_wrap">
            <a href="<?php echo G5_BBS_URL ?>/faq.php?fm_id=1"><div class="faq_list_cate"><img src="<?php echo G5_IMG_URL ?>/faq_membership<?php if($fm_id == '1') echo '_on'; ?>.png"></div></a><a href="<?php echo G5_BBS_URL ?>/faq.php?fm_id=2"><div class="faq_list_cate"><img src="<?php echo G5_IMG_URL ?>/faq_order<?php if($fm_id == '2') echo '_on'; ?>.png"></div></a><a href="<?php echo G5_BBS_URL ?>/faq.php?fm_id=3"><div class="faq_list_cate"><img src="<?php echo G5_IMG_URL ?>/faq_delivery<?php if($fm_id == '3') echo '_on'; ?>.png"></div></a><a href="<?php echo G5_BBS_URL ?>/faq.php?fm_id=4"><div class="faq_list_cate_end"><img src="<?php echo G5_IMG_URL ?>/faq_refund<?php if($fm_id == '4') echo '_on'; ?>.png"></div></a>
        </div>
