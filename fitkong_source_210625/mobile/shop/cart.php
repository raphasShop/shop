...
<header>
    <div class="mo_page_title_wrap"><a href="javascript:history.back();"><img src="<?php echo G5_IMG_URL; ?>/title_back.png" title=""></a> 장바구니</div>
</header>
    ...
    <div class="shop_con_wrap">
        <div id="sod_bsk" class="od_prd_list">
                ...
                for ($i=0; $row=sql_fetch_array($result); $i++)
                {
                    ...
                    if($it_options) {
                        ...
                        if ($row['it_id'] == '1622793578' || $row['it_id'] == '1622793637' || $row['it_id'] == '1622793630') {
                            $mod_options = '<div style="height:25px;"></div>';
            ...
            <div id="sod_bsk_act">
                ...
                <div style="text-align: center;font-size:12px;line-height:20px;font-weight:bold;padding:10px;color:#452417;border:1px solid #452417;margin-bottom:40px;">100원 프로모션 상품은 다른 상품과 함께 총 상품금액 20,000원 이상 구매 시, 주문가능합니다.</div>
                <?php } ?>
                <a href="<?php echo G5_SHOP_URL; ?>" class="btn01">쇼핑 계속하기</a>
