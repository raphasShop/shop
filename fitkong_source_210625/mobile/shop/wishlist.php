...
$wsh_referer = $_SERVER["HTTP_REFERER"];
if(preg_match('/item/i',$wsh_referer)){
    $referer = 'item';
} else if ($wsh_referer == ''){
    $referer = 'item';
} else {
...
<header>
    <?php if($referer == 'item') { ?>
    <div class="mo_page_title_wrap"><a href="javascript:history.back();"><img src="<?php echo G5_IMG_URL; ?>/title_back.png" title=""></a>  관심상품</div>
    <?php } else { ?>
    <div class="mo_page_title_wrap"><a href="<?php echo G5_SHOP_URL ?>/mypage.php"><img src="<?php echo G5_IMG_URL; ?>/title_back.png" title=""></a> 관심상품</div>
    <?php } ?>
</header>
        ...
        <div id="sod_ws" class="od_prd_list">
            ...
            <div class="tbl_head03 tbl_wrap">
                ...
                for ($i=0; $row = sql_fetch_array($result); $i++) {
                    ...
                    $image = get_it_image($row['it_id'],90, 90);
                ?>
                ...
                <tr>
                    ...
                    <td  class="td_prd">
                        ...
                        <div class="sod_delete"><a href="./wishupdate.php?w=d&amp;wi_id=<?php echo $row['wi_id']; ?>" class="wish_del">삭제</a></div>
                    </td>
                </tr>
                <?php 
                } // for 끝
                ...
                if ($i == 0) {
                    ...
                    echo '<tr><td colspan="8" class="empty_table">관심상품으로 등록된 상품이 없습니다.</td></tr>';
                } 
                ?>
                </tbody>
                </table>
            ...
            <div id="sod_bsk_act">
                <?php if ($i == 0) { ?>
                    ...
                    <?php } else { ?>
                    <a href="<?php echo G5_MSHOP_URL ?>"><button type="button" class="btn01">쇼핑 계속하기</button></a>
                    <?php } ?>
                <?php } else { ?>
                    <?php if($referer == 'item') { ?>
                    <button type="button" class="btn01" onclick="window.history.go(-1); return false;">쇼핑 계속하기</button>
