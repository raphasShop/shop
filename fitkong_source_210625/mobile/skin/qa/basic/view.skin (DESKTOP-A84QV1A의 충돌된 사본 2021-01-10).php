...
<div id="qa_list_wrap">
    ...
    <article id="bo_v">
        <div class="bo_v_wr">
            <header>
                <h2 id="bo_v_title">
                    <span>[ <?php echo $view['category'] ; // 분류 출력 끝 ?> ]</span><?php echo $view['subject']; // 글제목 출력  ?>
                </h2>
            </header>
            <section id="bo_v_info">
                <h2>페이지 정보</h2>
                <span class="sound_only">작성자</span><strong><?php echo $view['name'] ?><span class="bo_v_sepline">|</span><?php echo $view['datetime']; ?></strong>
            </section>
            ...
            <section id="bo_v_atc">
                ...
                <p style="margin-bottom:10px;font-weight: 800;"><?php echo get_item_name($view['qa_1']); ?></p>
                <?php
                // 파일 출력
                if($view['img_count']) {
        ...
        <div id="bo_v_top">
            ...
            ob_start();
             ?>
            <?php if ($is_admin && ($prev_href || $next_href)) { ?>
            <ul class="bo_v_nb">
