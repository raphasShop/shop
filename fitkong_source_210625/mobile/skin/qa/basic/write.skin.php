...
?>
<header>
    <div class="mo_page_title_wrap"><a href="javascript:history.back();"><img src="<?php echo G5_IMG_URL; ?>/title_back.png" title=""></a> 나의 문의 내역</div>
</header>

<div id="qa_list_wrap">
    <div class="qa_write_con_wrap">
    <section id="bo_w">
        ...
        <div class="form_01">
            <ul>
                ...
                <?php if ($is_email) { ?>
                <li class="bo_w_mail" style="display: none;">
                ...
                <?php } ?>
                <?php if ($is_hp) { ?>
                <li class="bo_w_hp" style="display: none;">
                ...
                <?php } ?>
                <input type="hidden" name="qa_email" value="<?php echo get_text($write['qa_email']); ?>" id="qa_email" <?php echo $req_email; ?> class="<?php echo $req_email.' '; ?>frm_input full_input email" size="50" maxlength="100" placeholder="이메일">
                <input type="hidden" name="qa_hp" value="<?php echo get_text($write['qa_hp']); ?>" id="qa_hp" <?php echo $req_hp; ?> class="<?php echo $req_hp.' '; ?>frm_input full_input" size="30" placeholder="휴대폰">

                <li class="bo_w_title">제목</li>
                <li class="bo_w_sbj">
