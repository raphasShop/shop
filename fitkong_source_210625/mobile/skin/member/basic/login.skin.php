...
add_stylesheet('<link rel="stylesheet" href="'.$member_skin_url.'/style.css?ver='.G5_CSS_VER.''.date("H:i:s").'">', 0);
?>
...
<div id="mo_color_background">
    ...
    <div id="mb_login" class="mbskin">
        ...
        <div class="mbskin" id="mb_login_od_wr">
            ...
            <fieldset id="mb_login_od">
                ...
                <div class="login_notice">
                    ...
                    <p>메일로 발송해드린 주문서의 <b>주문번호</b> 및 주문 시 입력하신 <b>비밀번호</b>를 정확히 입력해주십시오.</p>
                </div>
            ...
            <section class="login_register_banner">
                <a href="<?php echo G5_BBS_URL ?>/register.php"><img src="<?php echo G5_IMG_URL ?>/mo_register_coupon_bn.png?210610" alt="" class=""></a>
            </section>
        ...
        <div id="login_frm">
            ...
            <div class="login_kakao">
                <a href="<?php echo $self_url;?>?provider=kakao&amp;url=<?php echo $urlencode;?>" title="카카오">
                    <img src="<?php echo G5_IMG_URL ?>/mo_kakao_login.png" alt="" class="">
                </a>
            </div>
            <div class="login_social_box_naver" style="display: none;">
                <a href="<?php echo G5_BBS_URL ?>/register.php"><img src="<?php echo G5_IMG_URL ?>/login_naver.png" alt="" class="login_social_naver"></a>
            </div>
            <div class="login_social_box_kakao" style="display: none;">
                <a href="<?php echo G5_BBS_URL ?>/register.php"><img src="<?php echo G5_IMG_URL ?>/login_kakao.png" alt="" class="login_social_kakao"></a>
            </div>
        ...
        <section class="login_register_banner">
            <a href="<?php echo G5_BBS_URL ?>/register.php"><img src="<?php echo G5_IMG_URL ?>/mo_register_coupon_bn1.png?210610" alt="" class="" style="margin-bottom:7px;"></a>
            <a href="<?php echo G5_BBS_URL ?>/register.php"><img src="<?php echo G5_IMG_URL ?>/mo_register_coupon_bn.png?210610" alt="" class=""></a>
        </section>
