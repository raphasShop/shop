    ...
    <div id="login_mo_wrap">
         ...
         <?php
            if($config['cf_cert_use']) {
                ...
                if($config['cf_cert_hp'] && $config['cf_cert_hp'] != 'lg')
                    echo '<div class="register_cert_image" id="win_hp_cert"><input type="image" src="'.G5_IMG_URL.'/hp_certification.jpg" id="win_hp_cert"></div><div class="register_cert_text" id="win_hp_cert_text">휴대폰 인증</div>'.PHP_EOL;
                   // echo '<div class="register_cert_banner" id="win_hp_cert">인증<br>화면</div><div class="register_cert_text" id="win_hp_cert_text">휴대폰 인증</div>'.PHP_EOL;
        ...
        <div class="form_01">
            ...
            <li>
                ...
                <input type="text" name="mb_tel" value="<?php echo get_text($member['mb_tel']) ?>" id="reg_mb_tel" class="frm_input full_input <?php echo $config['cf_req_tel']?"required":""; ?>" maxlength="20" <?php echo $config['cf_req_tel']?"required":""; ?> placeholder="전화번호" readonly>
            </li>
            <?php } ?>
