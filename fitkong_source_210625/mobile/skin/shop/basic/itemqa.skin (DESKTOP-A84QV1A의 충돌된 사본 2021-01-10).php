...
<div id="sit_qa_wbtn">
    ...
    <div class="sit_qa_notice">
        <img src="https://fitkong.s3.ap-northeast-2.amazonaws.com/img/shop_review.png">
        <div class="sit_qa_notice_txt">핏콩제품에 관련한 궁금한 사항을 남겨주시면,<br>확인하는 즉시, 정확한 안내를 드리겠습니다.<br>기타 사항은 카톡 문의를 통해 남겨주시면, 친절히 안내드리겠습니다.</div>
    </div>
    <a href="<?php echo G5_BBS_URL ?>/qawrite.php?it_id=<?php echo $it_id; ?>" class="qa_write">상품문의 하기</a>
</div>

<!-- 상품문의 목록 시작 { -->
<div id="sit_qa_list" style="display: none">
