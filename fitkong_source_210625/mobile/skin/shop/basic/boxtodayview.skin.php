...
$tv_div['top'] = 0;
$tv_div['img_width'] = 300;
$tv_div['img_height'] = 300;
...
<div id="stv" class="op_area">
        ...
        <?php
            ...
            for ($i=1;$i<=$tv_idx;$i++)
            {
                ...
                $it_price = display_price($rowx['it_price']);
                ...
                echo $img;
                echo '<div class="menu_todayview_itname">';
                echo $it_name;
                echo '</div>'.PHP_EOL;
                echo '<div class="menu_todayview_itprice">';
                echo $it_price;
                echo '</div>'.PHP_EOL;
                echo '</div>'.PHP_EOL;
                echo '</div>'.PHP_EOL;
