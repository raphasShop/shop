...
<article id="bo_v" style="width:<?php echo $width; ?>">
    <header>
        <div class="mo_page_title_wrap"><a href="javascript:history.back();"><img src="<?php echo G5_IMG_URL; ?>/title_back.png"></a> 이벤트</div>
        <h2 id="bo_v_title">
            ...
            ?></span>
            <p><span class="bo_v_date"><?php echo $view['wr_1']; ?></span></p>
        </h2>
