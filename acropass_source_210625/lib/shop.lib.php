...
{
    if($is_star == 1) {
        $star = '<i class="xi-star"></i><i class="xi-star-o"></i><i class="xi-star-o"></i><i class="xi-star-o"></i><i class="xi-star-o"></i>';
    } else if($is_star == 2) {
        $star = '<i class="xi-star"></i><i class="xi-star"></i><i class="xi-star-o"></i><i class="xi-star-o"></i><i class="xi-star-o"></i>';
    } else if($is_star == 3) {
        $star = '<i class="xi-star"></i><i class="xi-star"></i><i class="xi-star"></i><i class="xi-star-o"></i><i class="xi-star-o"></i>';
    } else if($is_star == 4) {
        $star = '<i class="xi-star"></i><i class="xi-star"></i><i class="xi-star"></i><i class="xi-star"></i><i class="xi-star-o"></i>';
    } else if($is_star == 5) {
        $star = '<i class="xi-star"></i><i class="xi-star"></i><i class="xi-star"></i><i class="xi-star"></i><i class="xi-star"></i>';
    }
