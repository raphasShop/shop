...
<?php } ?>
    <div class="swiper-container banner-container">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide banner-slide" style="background-image: url('https://acropass2019.s3.ap-northeast-2.amazonaws.com/img/main_banner_back_210601.jpg');height:129.6296296296296vw;width:100vw;object-fit: cover">
               <div class="video-container">
                <iframe width="1080" height="1080" src="https://www.youtube.com/embed/8uWkR0Y6gOY?autoplay=0&amp;playlist=8uWkR0Y6gOY&amp;loop=1&amp;showinfo=0&amp;rel=0" showinfo="0" rel="0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="z-index: 100;"></iframe> 
                </div>               
            </div>
            <!-- 고정배너소스 
...
<section class="bestProduct">
    <div class="swiper-container best-product-container">
        ...
        <div class="swiper-wrapper">
            <?php
                $sql = " select * from {$g5['g5_shop_item_table']} where it_type4 = '1' AND it_use = '1' and it_5 != '1' order by it_1, it_order, it_id desc ";
                $list = new item_list();
                $list->set_query($sql);
                $list->run();
                $result = $list->result;
            ...
            <a href="<?php echo G5_SHOP_URL ?>/item.php?it_id=<?php echo $row['it_id'] ?>">
                ...
                <div class="product-price"><?php if($row['it_cust_price'] != $row['it_price'] && $row['it_cust_price'] != 0) { ?><span><?php echo number_format($row['it_cust_price']) ?>원</span> <?php } ?> <?php echo number_format($row['it_price']) ?>원</div>
            </a>
            </div>
            <?php } ?>
        </div>
