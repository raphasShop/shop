...
<div id="top_menu_wrap">
    <a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=notice"><div class="top_menu4_button menu_select">Notice</div></a><a href="<?php echo G5_BBS_URL ?>/faq.php"><div class="top_menu4_button">FAQ</div></a><a href="<?php echo G5_SHOP_URL ?>/membership.php"><div class="top_menu4_button">Membership</div></a><a href="<?php echo G5_SHOP_URL ?>/store.php"><div class="top_menu4_button">Store</div></a>
</div>
...
<section id="bo_w">
    ...
    <div class="form_01 write_div">
        ...
        <div class="bo_w_tit write_div">
            ...
            <div id="autosave_wrapper write_div">
                ...
                <?php } ?>
                <input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" required class="frm_input full_input required" size="50" maxlength="255" placeholder="이벤트 날짜">
                <input type="text" name="wr_2" value="<?php echo $wr_2 ?>" id="wr_2" required class="frm_input full_input required" size="50" maxlength="255" placeholder="이벤트배너 이미지주소">
                <input type="text" name="wr_3" value="<?php echo $wr_3 ?>" id="wr_3" class="frm_input full_input" size="50" maxlength="255" placeholder="이벤트 링크주소"> * 이벤트 링크를 등록하시면, 상세 이벤트 페이지 이동 없이 바로 해당 링크로 이동합니다.
            </div>
    ...
    <div class="btn_bottom top write_div">
