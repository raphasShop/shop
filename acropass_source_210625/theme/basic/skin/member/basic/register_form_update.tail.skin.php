...
$rst = kakaomsg('http://api.apistore.co.kr/kko/1/msg/raphas', array('PHONE'=>$receive_number, 'CALLBACK'=>'01024780137', 'MSG'=>$msg, 'TEMPLATE_CODE'=>'AC0001', 'BTN_TYPES'=>'웹링크', 'BTN_TXTS'=>'아크로패스 바로가기', 'BTN_URLS1'=>'http://acropass.com'));
}
//----------------------------------------------------------
// 알림톡전송 끝
//----------------------------------------------------------
