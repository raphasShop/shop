...
<aside id="bo_vc_w" class="bo_vc_w">
    ...
    <?php } else { ?>
      <span class="comment_msg"> ※<a href="<?php echo G5_BBS_URL ?>/login.php">로그인</a> 후, 댓글 작성이 가능합니다.</span>
    <?php } ?>
    </form>
    ...
    <article id="c_<?php echo $comment_id ?>" <?php if ($cmt_depth) { ?>style="margin-left:<?php echo $cmt_depth ?>px;border-top-color:#e0e0e0"<?php } ?>>
        ...
        <div class="cmt_contents">
            ...
            <?php if($list[$i]['is_reply'] || $list[$i]['is_edit'] || $list[$i]['is_del']) {
             ...
             ?>
            <ul class="bo_vc_act">
                <?php if ($is_admin) { ?><li><a href="<?php echo $c_reply_href;  ?>" onclick="comment_box('<?php echo $comment_id ?>', 'c'); return false;" class="btn_b03">답변</a></li><?php } ?>
