	...
	$.fn.extend({ 
		beforeAfter: function(options)
		{
			var defaults = 
			{
				...
				imagePath : 'https://d1wwy9ao3iinzu.cloudfront.net/img/product/kr/beforeafter/',
				cursor: 'pointer',
				clickSpeed: 600,
		...
		var randID =  Math.round(Math.random()*100000000);
			...
			$(obj).prepend('<div id="dragwrapper'+randID+'"><div id="drag'+randID+'"><img width="43" height="47.5" alt="handle" src="'+o.imagePath+'handle.png" id="handle'+randID+'" /></div></div>'); // Create drag handle
