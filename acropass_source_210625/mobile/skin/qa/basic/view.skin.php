...
<article id="bo_v">
    <div class="bo_v_wr">
        <header>
            <h2 id="bo_v_title">
                <span></span>
                [ <?php echo $view['category'] ; // 분류 출력 끝 ?> ] <?php echo $view['subject']; // 글제목 출력  ?>
            </h2>
        </header>
        ...
        <section id="bo_v_contact">
            ...
            <dl>
                <?php if($view['email']) { ?>
                <dt><i class="xi-mail" aria-hidden="true"></i><span class="sound_only">이메일</span></dt>
                <dd><?php echo $view['email']; ?></dd>
                <?php } ?>
                <?php if($view['hp']) { ?>
                <dt><i class="xi-mobile" aria-hidden="true"></i><span class="sound_only">휴대폰</span></dt>
