...
<div id="top_sub_gnb">
    <div class="top_sub_wrap">주문배송조회</div>
    <div class="top_back_btn"><a href="<?php echo G5_SHOP_URL; ?>/mypage.php"><i class="xi-angle-left"></i></a></div>
</div>
    ...
    <div id="order_list_wrap">
        <div id="sod_inquiry">
            <ul>
                ...
                for ($i=0; $row=sql_fetch_array($result); $i++)
                {
                    ...
                    switch($row['od_status']) {
                        case '주문':
                            ...
                            break;
                        case '입금':
                            $od_status = '<span class="status_02">결제완료</span>';
                            break;
                        case '준비':
                ...
                <li>
                    <a href="<?php echo G5_SHOP_URL; ?>/orderinquiryview.php?od_id=<?php echo $row['od_id']; ?>&amp;uid=<?php echo $uid; ?>&amp;ref=orderlist" class="idtime_link">
                    ...
                    <div class="test" style="width:100%;height:40px;background: #fff;color:#000;text-align: center;border:1px solid #000; line-height: 40px;font-size:12px;font-weight:bold;margin-top:10px;">리뷰 쓰기</div></a>
                    <?php } ?>
                </li>
