...
add_stylesheet('<link rel="stylesheet" href="'.G5_SHOP_CSS_URL.'/style.css?ver='.G5_CSS_VER.''.date("H:i:s").'">', 1);
...
<div id="sit_tab">
    ...
    <ul class="tab_con">
        ...
        ?>
        <?php if(!$row['bn_url'] || $row['bn_url'] != 'http://' || !$row['bn_url']) { ?><a href="<?php echo $row['bn_url']; ?>" target="<?php echo $bn_new; ?>"><?php } ?><img src="<?php echo $row['bn_img_url']; ?>" style="width:100%;">
        <?php if(!$row['bn_url'] || $row['bn_url'] != 'http://' || !$row['bn_url']) { ?></a><?php } }?>
