...
<div id="top_menu_wrap">
    <a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=notice"><div class="top_menu4_button">Notice</div></a><a href="<?php echo G5_BBS_URL ?>/faq.php"><div class="top_menu4_button menu_select">FAQ</div></a><a href="<?php echo G5_SHOP_URL ?>/membership.php"><div class="top_menu4_button">Membership</div></a><a href="<?php echo G5_SHOP_URL ?>/store.php"><div class="top_menu4_button">Store</div></a>
</div>
<?php
    ...
    <ul id="faq_cate_ul">
        ...
        foreach( $faq_master_list as $v ){
            ...
            if($v['fm_id'] == $fm_id){ // 현재 선택된 카테고리라면
                $category_option = ' id="faq_cate_on"';
