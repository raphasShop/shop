...
<div id="top_menu_wrap">
    <a href="<?php echo G5_BBS_URL ?>/login.php"><div class="top_menu2_button">회원로그인</div>
    <a href="<?php echo G5_SHOP_URL ?>/orderinquiry.php"><div class="top_menu2_button menu_select">비회원 주문조회</div></a>
</div>
<?php } else { ?>
<div id="top_menu_wrap">
    <a href="<?php echo G5_BBS_URL ?>/login.php"><div class="top_menu2_button menu_select">회원로그인</div>
    <a href="<?php echo G5_SHOP_URL ?>/orderinquiry.php"><div class="top_menu2_button">비회원 주문조회</div></a>
</div>
<?php } ?>


<div id="top_sub_gnb">
    <div class="top_sub_wrap_no_shadow">로그인</div>
