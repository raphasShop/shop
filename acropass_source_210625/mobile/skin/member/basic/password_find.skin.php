...
<div id="find_info" class="new_win">
    ...
    <div class="new_win_con">
        ...
        <fieldset id="info_fs">
            <p>
                가입대신 계정의 아이디와 이름 및 휴대폰 번호를 입력해주세요.<br>
                해당 휴대폰번호로 임시비밀번호를 보내드립니다.
            </p>
            <input type="text" id="mb_id" name="mb_id" placeholder="아이디(필수)" required class="frm_input">
        ...
        <div class="win_btn">
            <input type="submit" class="btn_submit" value="비밀번호찾기">
