...
<div>
    ...
    <div class="register_process_wrap">
        <div class="register_process">약관동의</div><div class="process_arrow"><i class="xi-angle-right"></i></div><div class="register_process process_now">본인인증</div><div class="process_arrow"><i class="xi-angle-right"></i></div><div class="register_process">정보입력</div>
    </div>

    <div class="register_title_wrap">
        <div class="register_main_title">회원가입 시 본인 인증</div>
        <div class="register_sub_title">안전한 회원 가입을 위해 본인 인증을 해주세요.<br>전자상거래 법에 의해 만 14세 미만은 회원가입이 제한됩니다.</div>
    </div>
     ...
     <?php
        if($config['cf_cert_use']) {
            if($config['cf_cert_ipin'])
                echo '<div class="register_cert_image"><input type="image" src="'.G5_IMG_URL.'/acm-join-phone.png" id="win_hp_cert" class="register_cert_btn"></div><div class="register_cert_text">아이핀 본인인증</div>'.PHP_EOL;
            if($config['cf_cert_hp'] && $config['cf_cert_hp'] != 'lg')
                echo '<div class="register_cert_image"><input type="image" src="'.G5_IMG_URL.'/acm-join-phone.png" id="win_hp_cert" class="register_cert_btn"></div><div class="register_cert_text" id="win_hp_cert_text">휴대폰 본인인증</div>'.PHP_EOL;
    ...
    <div class="register_process_wrap">
        <div class="register_process">약관동의</div><div class="process_arrow"><i class="xi-angle-right"></i></div><div class="register_process">본인인증</div><div class="process_arrow"><i class="xi-angle-right"></i></div><div class="register_process process_now">정보입력</div>
    </div>
    <?php } ?>
    <div class="register_title_wrap">
        <div class="register_main_title">회원 정보 입력</div>
        <div class="register_sub_title">서비스 이용에 필요한 회원 정보를 입력해주세요.</div>
    </div>
    ...
    <div class="form_01">
        ...
        <li>
            ...
            <label for="reg_mb_mailling" class="frm_label"><span></span>ACROPASS에서 제공하는 정보 메일을 받겠습니다.</label>
