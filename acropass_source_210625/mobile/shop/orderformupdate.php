...
$rst = kakaomsg('http://api.apistore.co.kr/kko/1/msg/raphas', array('PHONE'=>$kakao_rcv_number, 'CALLBACK'=>'01024780137', 'MSG'=>$msg, 'TEMPLATE_CODE'=>'AC0003'));
} else {
    $msg = "[아크로패스]\r\n".$od_name."님 안녕하세요!\r\n".$od_id." 결제완료 되었습니다. 감사합니다.\r\n조금만 기다려주세요.\r\n빠른배송 준비하겠습니다\r\n- 주문일 : ".$today."\r\n- 주문번호: ".$od_id."\r\n- 상품명: ".$it_namex."";
$rst = kakaomsg('http://api.apistore.co.kr/kko/1/msg/raphas', array('PHONE'=>$kakao_rcv_number, 'CALLBACK'=>'01024780137', 'MSG'=>$msg, 'TEMPLATE_CODE'=>'AC0002', 'BTN_TYPES'=>'웹링크', 'BTN_TXTS'=>'아크로패스 바로가기', 'BTN_URLS1'=>'http://acropass.com'));
}
