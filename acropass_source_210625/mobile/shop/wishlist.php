...
?>
<div id="top_sub_gnb">
    <div class="top_sub_wrap">위시리스트</div>
        ...
        <li>
            ...
            <div class="wish_info">
                ...
                <div class="wish_chk">
                    ...
                    <input type="checkbox" name="chk_it_id[<?php echo $i; ?>]" id="chk_it_id[<?php echo $i; ?>]" value="1" onclick="out_cd_check(this, '<?php echo $out_cd; ?>');">
                    <label for="chk_it_id[<?php echo $i; ?>]"><span></span></label> 
                    <?php } ?>
                ...
                <span class="wish_del"><a href="<?php echo G5_SHOP_URL; ?>/wishupdate.php?w=d&amp;wi_id=<?php echo $row['wi_id']; ?>"><i class="xi-close-thin" aria-hidden="true"></i><span class="sound_only">삭제</span></a></span>
            </div>
