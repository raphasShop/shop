...
$sql_search = " where a.mb_id = '$mb_id' AND a.is_confirm = '1' ";
...
<div id="top_sub_gnb">
    <div class="top_sub_wrap"><?php echo '나의 리뷰 내역' ?></div>
    <div class="top_back_btn"><a href="javascript:history.back();"><i class="xi-angle-left"></i></a></div>
</div>

<?php
$itemuselist_skin = G5_MSHOP_SKIN_PATH.'/myitemuselist.skin.php';
