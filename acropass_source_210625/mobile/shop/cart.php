...
<div id="top_sub_gnb">
    <div class="top_sub_wrap">장바구니</div>
...
<div id="sod_bsk">
    ...
    <div id="sod_chk">
        ...
        <label for="ct_all"><span></span>전체상품 선택</label>
    </div>
    <?php } ?>
        ...
        <li class="sod_li">
            ...
            <div class="li_name">
                <span class="li_chk">
                    ...
                    <label for="ct_chk_<?php echo $i; ?>" ><span></span></label>
                </span>
                <?php echo $it_name; ?>
    ...
    <div id="sod_bsk_act" class="btn_confirm">
        <button type="button" onclick="location.href='<?php echo G5_SHOP_URL; ?>'" class="btn_home">쇼핑계속하기</button>
...
if (!_nasa) var _nasa={};
_nasa["cnv"] = wcs.cnv("3","1"); // 구매완료 전환 스크립트
wcs_do(_nasa);
</script> 
