...
<div id="sit_ov_wrap">
    ...
    <section id="sit_ov" class="2017_renewal_itemform">
            ...
            if($it['it_sc_type'] == 1)
                ...
                if($it['it_sc_method'] == 1)
                    ...
                    if($it['it_sc_minimum'] != 0) {
                        $sc_method = '주문시 결제('.$it['it_sc_minimum'].'원 이상 구매 시 무료배송)';
                    } else {
                        $sc_method = '무료배송';
                    }
                }
        ...
        <div id="sit_ov_btn">
            <?php if ($is_orderable) { ?>
            <button type="submit" onclick="document.pressed=this.value;" value="바로구매" id="sit_btn_buy"><i class="xi-credit-card" aria-hidden="true"></i> 바로구매</button>
