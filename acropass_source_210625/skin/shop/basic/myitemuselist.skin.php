...
<div class="my_title_wrap">
    ...
    <div class="my_sub_title">나의리뷰내역</div>
</div>

<div id="mypage_pc_wrap">

<div id="my_use_board_wrap">
    <div class="my_use_board_title">최근 3년 내 목록만 조회가능합니다.</div>
</div>
...
<div id="sit_use_list">
    ...
    if (!$i) echo '<div id="my_use_list_wrap"> <div class="my_use_list_none"> <img src="'.G5_IMG_URL.'/acm-none-img.png">
        <div class="my_use_none_msg">등록된 리뷰가 없습니다</div> </div></div>';    ?>
</div>
