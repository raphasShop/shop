...
<div class="customer_title_wrap">
    ...
    <div class="customer_sub_title">FAQ</div>
</div>
<div id="customer_pc_wrap">
...
<div id="customer_top_menu">
    <a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=notice"><div class="top_menu_pc_button">Notice</div></a><a href="<?php echo G5_BBS_URL ?>/faq.php"><div class="top_menu_pc_button menu_select">FAQ</div></a><a href="<?php echo G5_SHOP_URL ?>/membership.php"><div class="top_menu_pc_button">Membership</div></a><a href="<?php echo G5_SHOP_URL ?>/store.php"><div class="top_menu_pc_button">Store</div></a>
</div>
<!-- FAQ 시작 { -->
<?php
// 상단 HTML
...
<div id="faq_sch">
    ...
    <input type="text" name="stx" value="<?php echo $stx;?>" required id="stx" class="frm_input" size="15" maxlength="15" placeholder="검색어를 입력해주세요">
    <button type="submit" value="검색" class="btn_submit"><i class="xi-search" aria-hidden="true"></i><span class="sound_only">검색</span></button>
    </form>
</div>
