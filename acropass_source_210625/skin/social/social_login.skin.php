...
<div class="login-sns sns-wrap-32 sns-wrap-over" id="sns_login">
    ...
    <div class="sns-login-wrap">
        ...
        <a href="<?php echo $self_url;?>?provider=facebook&amp;url=<?php echo $urlencode;?>" title="페이스북">
            <div class="sns-circle-icon"><img src="<?php echo G5_IMG_URL ?>/sns-facebook.png"><p class="sns-circle-text">페이스북</p></div>
        </a>
        <?php }     //end if ?>
        <?php if( social_service_check('kakao') ) {     //카카오 로그인을 사용한다면 ?>
        <a href="<?php echo $self_url;?>?provider=kakao&amp;url=<?php echo $urlencode;?>" title="카카오">
            <div class="sns-circle-icon sns-circle-center"><img src="<?php echo G5_IMG_URL ?>/sns-kakao.png"><p class="sns-circle-text">카카오톡</p></div>
        </a>
        <?php }     //end if ?>
        ...
        <a href="<?php echo $self_url;?>?provider=naver&amp;url=<?php echo $urlencode;?>" title="네이버">
            <div class="sns-circle-icon"><img src="<?php echo G5_IMG_URL ?>/sns-naver.png"><p class="sns-circle-text">네이버</p></div>
        </a>
        <?php }     //end if ?>
        ...
        <a href="<?php echo $self_url;?>?provider=twitter&amp;url=<?php echo $urlencode;?>" title="트위터">
            <div class="sns-circle-icon"><img src="<?php echo G5_IMG_URL ?>/sns-twitter.png"><p class="sns-circle-text">트위터</p></div>
        </a>
        <?php }     //end if ?>
