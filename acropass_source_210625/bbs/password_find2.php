...
$msg = "[아크로패스] ".$mb['mb_name']."님의 임시비밀번호는\r\n".$change_password." 입니다.\r\n로그인 후 비밀번호를 변경하세요.";
$rst = kakaomsg('http://api.apistore.co.kr/kko/1/msg/raphas', array('PHONE'=>$kakao_rcv_number, 'CALLBACK'=>'01024780137', 'MSG'=>$msg, 'TEMPLATE_CODE'=>'AC0009', 'BTN_TYPES'=>'', 'BTN_TXTS'=>''));
...
alert_close($email.' 입력하신 휴대폰번호로 임시비밀번호가 발송 되었습니다.\\n\\n카카오톡 알림톡을 확인하여 주십시오.');
?>
