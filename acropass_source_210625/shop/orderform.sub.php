        ...
        <section id="sod_frm_pay">
            ...
            <div class="pay_tbl">
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" id="code_coupon_btn" class="btn_frmline">쿠폰등록</button>
                    </td>
                </tr>
                <tr>
                    <input type="hidden" name="url" value="<?php echo G5_SHOP_URL; ?>/orderform.php?sw_direct=1">
                    <td colspan="2"><input type="text" name="coupon_code" class="coupon_board_input" id="coupon_code" value="" placeholder="쿠폰코드입력" style="font-size:15px; padding:5px 50px;text-align: center;"></td>
            ...
            <div class="sod_frm_point">
                <div>
                    ...
                    <input type="text" name="od_temp_point" value="0" id="od_temp_point" class="frm_input" size="10" onKeyup="point_change(this.value);"> 점
                </div>
                <div id="sod_frm_pt">
