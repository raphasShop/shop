...
function print_menu2($key, $no) {
    ...
    for($i=1; $i<count($menu[$key]); $i++) {
        ...
        if($member['mb_id'] == 'administrator' && (($key == 'menu155' && $i == 1) || ($key == 'menu155' && $i == 2) || ($key == 'menu155' && $i == 3) || ($key == 'menu155' && $i == 4) || ($key == 'menu155' && $i == 5) || ($key == 'menu155' && $i == 6) || ($key == 'menu155' && $i == 7) || ($key == 'menu155' && $i == 8) || ($key == 'menu155' && $i == 9) || ($key == 'menu200' && $i == 3) || ($key == 'menu200' && $i == 6) || ($key == 'menu200' && $i == 7) || ($key == 'menu200' && $i == 9) || ($key == 'menu300' && ($i == 1 || $i == 2 || $i == 3 || $i == 4 || $i == 5 || $i == 9)) || ($key == 'menu400' && ($i == 8 || $i == 9 || $i == 10 || $i == 11)) || ($key == 'menu411' && ($i == 1 || $i == 3)) || ($key == 'menu422' && $i == 10 ) || ($key == 'menu455' && $i == 3) || ($key == 'menu500' && $i == 13) )) {} else {
...
<header id="hd">
    <div id="hd_wrap">
        ...
        <ul id="tnb">
            ...
            <li>
                <div id="logo"><a href="<?php echo G5_ADMIN_URL ?>" class="at-tip" data-original-title="<nobr>아크로패스<br>관리자</nobr>" data-toggle="tooltip" data-placement="right" data-html="true"><img src="<?php echo G5_IMG_URL;?>/acropass_logo.png"></a></div>  
            </li>
            ...
            <?php// } ?>
            <!--//-->
            <li><a href="http://en.acropass.com/adm" target="_blank">EN</a><a href="http://cn.acropass.com/adm" target="_blank">CN</a></li>
        </ul>
        </div>
                    ...
                    <div id="gnbmenubar">
                        ...
                        foreach($amenu as $key=>$value) {
                            ...
                            if ($menu['menu'.$key][0][2]) {
                                if($key == '155') {
                                    $href1 = '<a href="'.$menu['menu'.$key][10][2].'" class="gnb_1da">';
                                    $href2 = '</a>';
                                } else {
