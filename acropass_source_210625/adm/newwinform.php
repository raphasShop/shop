...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        ...
        <td>
            <?php echo help("커뮤니티, 쇼핑몰, 관리자에 노출할 것인지를 설정합니다."); ?>
            <select name="nw_division" id="nw_division">
                <option value="both"<?php echo get_selected($nw['nw_division'], 'both', true); ?>>메인과 쇼핑몰</option>
                <option value="comm"<?php echo get_selected($nw['nw_division'], 'comm'); ?>>메인</option>
                <option value="shop"<?php echo get_selected($nw['nw_division'], 'shop'); ?>>쇼핑몰</option>
                <option value="adm"<?php echo get_selected($nw['nw_division'], 'adm'); ?>>관리자</option>
            </select>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            ...
            <?php echo help("0 을 입력하시면 몇시간 동안 보지않기 버튼이 나타나지 않습니다."); ?>
    ...
    <tr>
        <th scope="row"><label for="nw_padding">내용 상하좌우 패딩값<strong class="sound_only"> 필수</strong></label></th>
        <td>
            <input type="text" name="nw_padding" value="<?php echo $nw['nw_padding'] ?>" id="nw_padding" class="frm_input" size="5"> px
        </td>
    </tr>
    </tbody>
    </table>
...
<div id="bq_right1">   
    <div class="bq_basic">
    <a href="./newwinlist.php"><i class="fas fa-tasks"></i> 목록</a>
    </div>
