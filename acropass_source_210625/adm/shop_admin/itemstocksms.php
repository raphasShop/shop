<?php
$sub_menu = '455400'; /* 수정전 원본 메뉴코드 500400 */
...
<div class="local_desc03 local_desc">
    <strong><?php echo number_format($total_count); ?></strong> 개의 알림신청이 검색되었습니다. 미전송된 알림신청은 <strong><?php echo number_format($unsend_count); ?></strong> 개가 있습니다.
</div>
<!-- // -->
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td>
		<?php echo $it_name;//상품명 ?>
        <span class="go_link"><a href="<?php echo G5_URL;?>/shop/item.php?it_id=<?php echo $row['it_id']; ?>" target="_blank">상품보기</a></span>
        </td>
