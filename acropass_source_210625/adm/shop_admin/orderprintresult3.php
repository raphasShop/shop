...
if ($csv == 'xls')
{
    ...
    $data = array('결제일시','주문일시','주문번호','네이버페이주문','주문자ID','주문자명','주문자전화번호','상품명','옵션명','주문수량','주문품목단가','상품별 총 주문금액','배송비','배송비무료쿠폰','쿠폰할인금액','사용한적립금','적립금','총 결제금액(실결제금액)','결제방법','주문상태','현금영수증');
    ...
    for($i=1; $row=sql_fetch_array($result); $i++)
    {
        ...
        $worksheet->write($i, 6, ' '.$row['od_tel']);//주문자전화번호
