...
// 상품아이디,조회수,판매여부,쿠폰적용여부,상점메모,아이피,상품등록일,수정일 등은 복사등록하지 않음
$sql_common = "";
$fields = sql_field_names($g5['g5_shop_item_table']);
foreach($fields as $fld) {
    if ($fld == 'it_id' || $fld == 'it_sum_qty' || $fld == 'it_hit' || $fld == 'it_use' || $fld == 'it_use_cnt' || $fld == 'it_use_avg' || $fld == 'it_ip' || $fld == 'it_time' || $fld == 'it_update_time')
        continue;
