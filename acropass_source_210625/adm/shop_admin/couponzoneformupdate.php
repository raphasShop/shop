...
if(!$_POST['cz_code'])
    alert('쿠폰코드를 입력해 주십시오.');

if(!$_POST['cz_code_max'])
    alert('쿠폰코드 발행 개수를 입력해 주십시오.');

if(!$_POST['cz_code_start'] || !$_POST['cz_code_end'])
    alert('쿠폰코드 사용 시작일과 종료일을 입력해 주십시오.');

if($_POST['cz_code_start'] > $_POST['cz_code_end'])
    alert('쿠폰코드 사용 시작일은 종료일 이전으로 입력해 주십시오.');
...
if($_POST['cp_type'] && ($_POST['cp_price'] < 1 || $_POST['cp_price'] > 100))
...
$sql_common = " cz_subject  = '{$_POST['cz_subject']}',
                cz_code     = '{$_POST['cz_code']}', 
                cz_code_max = '{$_POST['cz_code_max']}',
                cz_type     = '{$_POST['cz_type']}',
                cz_code_start = '{$_POST['cz_code_start']}',
                cz_code_end = '{$_POST['cz_code_end']}',
