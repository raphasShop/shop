...
<button type="button" onClick="location.href='<?php echo G5_ADMIN_URL; ?>/shop_admin/cartlist.php'"><i class="fa fa-refresh" aria-hidden="true"></i> 선택초기화</button>
</div>
</form>
<!-- 검색창 끝 -->
...
<div class="local_desc03 local_desc">
    <strong><?php echo number_format($total_count); ?></strong> 개의 장바구니 상품이 검색되었습니다
</div>
<!-- // -->
...
<div class="local_desc01 local_desc">
    <p>고객님들이 장바구니에 가장 많이 넣은 순으로 순위를 출력합니다.</p>
</div>
...
<div id="scroll-button" style="display:none;">
    <div class="btn_scroll_basic btn_list">
		<?php if(!$fr_date && !$to_date) { //전체기간?>
            분류나 기간별로 보실 수 있습니다.
        <?php } else { //기간선택?>
		    장바구니순위 적용기간&nbsp;&nbsp;<span class="black"><?php echo $fr_date; ?> ~ <?php echo $to_date; ?></span>
        <?php } ?>
    </div>
</div>
<!--//-->
