...
<!-- wetoz : naverpayorder -->
<?php @include_once(G5_DATA_PATH.'/cache/naverpayorder-ordersync.php');?>
<div class="btn_confirm01 btn_confirm" style="margin-top:10px;"><a href="#none" onclick="sync_naverapi();" id="btn-naverapi">네이버 주문정보 동기화 <?php if ($InqTimeFrom) echo '(최종 : '.str_replace('T', ' ', $InqTimeFrom).')';?></a></div>
