...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        ...
        <td>
            ...
            <input type="checkbox" name="cp_sms_send" value="1" id="cp_sms_send">
            <label for="cp_email_send">이메일발송</label>
            <input type="checkbox" name="cp_email_send" value="1" id="cp_email_send">
        </td>
    </tr>
    <?php } ?>
    </tbody>
...
<div id="bq_right1">   
    <div class="bq_basic">
    <a href="./couponlist.php?<?php echo $qstr; ?>"><i class="fas fa-tasks"></i> 목록</a>
    </div>
