...
$menu['menu155'] = array (
	...
	// 배너,팝업 등 관리
	array('155300', '<i class="fab fa-adversal"></i> 배너관리', G5_ADMIN_URL.'/shop_admin/bannerlist.php', 'pmt_banpop', 1),
    array('155301', $treeicon.'(쇼핑몰) 메인배너', G5_ADMIN_URL.'/shop_admin/bannerlist.php', 'pmt_banner', 2),
	array('155351', $treeicon.'(공통) 탑배너관리', G5_ADMIN_URL.'/top.banner_admin/top.banner.php', 'top.banner', 2),
	array('155301', '배너관리', G5_ADMIN_URL.'/shop_admin/bannerlist.php', 'pmt_banner'),
	// 컨텐츠배너관리
	array('155701', '컨텐츠배너관리', G5_ADMIN_URL.'/shop_admin/con_bannerlist.php', 'pmt_conbanner'),
	// 리뷰팝업관리
