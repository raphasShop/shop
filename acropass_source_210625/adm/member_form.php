...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        ...
        <?php if ($is_admin = 'super') { //최고관리자만 볼수있음?>
            <input type="text" name="mb_email" value="<?php echo $mb['mb_email'] ?>" id="mb_email" maxlength="100" required class="required frm_input email w90per">
        <?php } else { //부운영자안내글?>
            <span class="skyblue">※ 최고관리자만 열람 가능</span>
        <?php } //닫기?>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><input type="text" name="mb_sex" value="<?php echo $mb['mb_sex'] ?>" id="mb_sex" class="frm_input" maxlength="255" size="15"></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="td_addr_line">
            ...
            <input type="text" name="mb_addr1" value="<?php echo $mb['mb_addr1'] ?>" id="mb_addr1" class="frm_input w80per readonly">
            <label for="mb_addr1">기본주소</label><br>
            <input type="text" name="mb_addr2" value="<?php echo $mb['mb_addr2'] ?>" id="mb_addr2" class="frm_input w80per">
            <label for="mb_addr2">상세주소</label>
            <br>
            <input type="text" name="mb_addr3" value="<?php echo $mb['mb_addr3'] ?>" id="mb_addr3" class="frm_input w80per">
    ...
    <!-- 회원이미지 관리자모드에서 업로드 가능하게 추가 - 아이스크림 -->
    <tr>
        <th scope="row"><label for="mb_img">회원프로필이미지</label></th>
        <td>
                <?php echo help('회원프로필 이미지 크기는 <strong>넓이 '.$config['cf_member_img_width'].'픽셀 높이 '.$config['cf_member_img_height'].'픽셀</strong>이하로 해주세요<br>gif 또는 jpg만 가능하며 용량 '.number_format($config['cf_member_img_size']).'byte 이하만 등록됩니다.') ?>
                <input type="file" name="mb_img" id="reg_mb_img" >

                <?php
				// 회원이미지 경로
                $mb_img_path = G5_DATA_PATH.'/member_image/'.substr($mb['mb_id'],0,2).'/'.$mb['mb_id'].'.gif';
                $mb_img_url  = G5_DATA_URL.'/member_image/'.substr($mb['mb_id'],0,2).'/'.$mb['mb_id'].'.gif';
    ...
    <tr>
        ...
        <td>
            ...
            <input type="checkbox" name="mb_mailling" value="1" id="mb_mailling"<?php echo $mb['mb_mailling']?' checked':''; ?>> 메일수신
            <div class="check-slider round"></div>
            </label>
            <label for="mb_mailling">메일수신설정</label>
        </td>
    </tr>
    <tr>
        ...
        <td>
            ...
            <label class="switch-check">
            <input type="checkbox" name="mb_sms" value="1" id="mb_sms"<?php echo $mb['mb_sms']?' checked':''; ?>> SMS수신
            <div class="check-slider round"></div>
            </label>
            <label for="mb_sms">SMS수신설정</label>
        </td>
    </tr>
    <tr>
        ...
        <td>
            ...
            <label class="switch-check">
            <input type="checkbox" name="mb_open" value="1" id="mb_open"<?php echo $mb['mb_open']?' checked':''; ?>> 정보공개
            <div class="check-slider round"></div>
            </label>
            <label for="mb_open">정보공개설정</label>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" name="mb_leave_date" value="<?php echo $mb['mb_leave_date'] ?>" id="mb_leave_date" class="frm_input" maxlength="19">
            <input type="checkbox" value="<?php echo date("Y-m-d H:i:s"); ?>" id="mb_leave_date_set_today" onclick="if (this.form.mb_leave_date.value==this.form.mb_leave_date.defaultValue) {
this.form.mb_leave_date.value=this.value; } else { this.form.mb_leave_date.value=this.form.mb_leave_date.defaultValue; }">
            <label for="mb_leave_date_set_today">탈퇴일 오늘</label>
        </td>
    </tr>
    <tr>
        <th scope="row">접근차단일자</th>
        <td>
            <input type="text" name="mb_intercept_date" value="<?php echo $mb['mb_intercept_date'] ?>" id="mb_intercept_date" class="frm_input" maxlength="19">
            <input type="checkbox" value="<?php echo date("Y-m-d H:i:s"); ?>" id="mb_intercept_date_set_today" onclick="if
...
this.form.mb_intercept_date.value=this.form.mb_intercept_date.defaultValue; }">
            <label for="mb_intercept_date_set_today">접근차단일 오늘</label>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td><input type="text" name="mb_<?php echo $i ?>" value="<?php echo $mb['mb_'.$i] ?>" id="mb_<?php echo $i ?>" class="frm_input" maxlength="255"></td>
    </tr>
    <?php } ?>
...
<div id="bq_right1">   
    <div class="bq_basic">
    <a href="./member_list.php?<?php echo $qstr ?>"><i class="fas fa-tasks"></i> 목록</a>
    </div>
