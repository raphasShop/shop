...
<div class="local_desc01">
    <ul>
        <li class="title1">테스트 메일이 오지않는 경우</li>
        <li class="content-list-txt1">
        ※ 수정할 파일 : /config.php<br>
        ※ confing.php파일을 열어 150번 줄 부근에서 SMTP로 표시된 부분을 찾아서 수정하면 됩니다
        </li>
        <li class="txt1">
        <strong>(1) 변경전</strong><br>
        // SMTP<br>
        // lib/mailer.lib.php 에서 사용<br>
        define('G5_SMTP', '127.0.0.1');<br>
        define('G5_SMTP_PORT', '25');<br>
        </li>
        <li class="txt1">
        <strong>(2) 변경후</strong><br>
        // SMTP<br>
        // lib/mailer.lib.php 에서 사용<br>
        define('G5_SMTP', '');<br>
        define('G5_SMTP_PORT', '25');<br>
